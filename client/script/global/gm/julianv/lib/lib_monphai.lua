...
tbMonPhai.FacInfo = { -- Thong tin tong hop
    [tbMonPhai.FacList.TL] = {
        ...
        szName = "ThiÕu L©m",
        tbPlaWeapon = {
            { "Anh Hµo La H¸n TriÒn Thñ", 8483 }, { "Anh Hµo PhËt §µ T¨ng C«n", 8493 },
    ...
    [tbMonPhai.FacList.TV] = {
        ...
        szName = "Thiªn V­¬ng",
        tbPlaWeapon = {
            { "Anh Hµo Tö Kim Chïy", 8513 }, { "Anh Hµo Hæ §Çu Th­¬ng", 8523 },
    ...
    [tbMonPhai.FacList.TY] = {
        ...
        szName = "Thuý yªn",
        tbPlaWeapon = {
            { "Anh Hµo Tè La §ao", 8563 }, { "Anh Hµo BÝch La Uyªn ¦¬ng§ao", 8573 },
        },
        tbGoldWeapon = { 46 },
        tbGoldEquip = {
            [10] = "Thuý Yªn §¬n §ao",
    ...
    [tbMonPhai.FacList.ND] = {
        ...
        szName = "Ngò §éc",
        tbPlaWeapon = {
            { "Anh Hµo Ban Lan TriÒn Thñ", 8583 }, { "Anh Hµo Lôc Quang §éc NhËn", 8593 },
        },
        tbGoldWeapon = { 61 },
        tbGoldEquip = {
            [12] = "Ngò §éc Ch­ëng",
    ...
    [tbMonPhai.FacList.DM] = {
        ...
        szName = "§­êng M«n",
        tbPlaWeapon = {
            { "Anh Hµo BÝ Linh Phi §ao", 8603 }, { "Anh Hµo Tµn V©n TIÔn", 8613 },
    ...
    [tbMonPhai.FacList.TN] = {
        ...
        szName = "Thiªn NhÉn",
        tbPlaWeapon = {
            { "Anh Hµo LÖ ¢m Th­¬ng", 8653 }, { "Anh Hµo NghiÖp Háa §ao", 8663 },
        },
        tbGoldWeapon = { 101 },
        tbGoldEquip = {
            [21] = "Thiªn NhÉn KÝch",
    ...
    [tbMonPhai.FacList.VD] = {
        szPinyin = "wudang",
        szName = "Vâ §ang",
        tbPlaWeapon = { { "Anh Hµo Th¸i Cùc KiÕm", 8673 },
    ...
    [tbMonPhai.FacList.CL] = {
        szPinyin = "kunlun",
        szName = "C«n L«n",
        tbPlaWeapon = { { "Anh Hµo B¹ch Hång §ao", 8693 },
    ...
    [tbMonPhai.FacList.HS] = {
        ...
        szName = "Hoa S¬n",
        tbPlaWeapon = {
            { "Anh Hµo Th­¬ng Lan KiÕm", 8713 }, { "Anh Hµo BÝch Hoa KiÕm", 8723 },
        },
    },
    ...
    [tbMonPhai.FacList.TD] = {
        ...
        szName = "Tiªu Dao",
        tbPlaWeapon = {
            { "Anh Hµo Chi Di T¾c CÇm", 8753 }, { "Anh Hµo Chi Hoa Èn KiÕm", 8763 },
        },
    },
}
tbMonPhai.tbMisc = { -- Ngu hanh - ngoai trang - pk ...
    ...
    [1] = {
        szNgoaiTrang = "Mò",
        tbSeries = { "Méc", "green" },
        tbPK_Status = { "ChÝnh Ph¸i", "orange", "Vµng" },
    },
    [2] = {
        szNgoaiTrang = "¸o",
        tbSeries = { "Thuû", "blue" },
        tbPK_Status = { "Tµ Ph¸i", "pink", "TÝm" },
    },
    [3] = {
        szNgoaiTrang = "Vò khÝ",
        tbSeries = { "Ho¶", "red" },
        tbPK_Status = { "Trung LËp", "green", "Xanh" },
    },
    [4] = {
        szNgoaiTrang = "Ngùa",
        tbSeries = { "Thæ", "orange" },
