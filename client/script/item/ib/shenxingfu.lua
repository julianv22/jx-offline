...
function main()    
    ...
    if (IsDisabledUseTownP() == 1 or GetTaskTemp(200) == 1) or
        (SubWorldIdx2ID(SubWorld) >= 387 and SubWorldIdx2ID(SubWorld) <= 395) then
    ...
    if (nSubWorldID >= 375 and nSubWorldID <= 386) then
        Msg2Player(
            "B¶n ®å hiÖn t¹i ng­¬i ®ang ®øng thuéc khu vùc ®Æc thï, kh«ng thÓ sö dông thÇn hµnh phï.");
        return 1
    end
    ...
    if (nSubWorldID == 44 or nSubWorldID == 197 or nSubWorldID == 208 or nSubWorldID == 209 or
        nSubWorldID == 210 or nSubWorldID == 211 or nSubWorldID == 212 or
        (nSubWorldID >= 213 and nSubWorldID <= 223) or nSubWorldID == 336 or nSubWorldID == 341 or
        nSubWorldID == 342 or nSubWorldID == 175 or nSubWorldID == 337 or nSubWorldID == 338 or
        nSubWorldID == 339 or (nSubWorldID >= 387 and nSubWorldID <= 395)) then
        Msg2Player(
            "B¶n ®å hiÖn t¹i ng­¬i ®ang ®øng thuéc khu vùc ®Æc thï, kh«ng thÓ sö dông thÇn hµnh phï.");
        return 1
    end
    ...
    if (GetLevel() < 5) then
        Say(
            "Ng­êi ch¬i ph¶i ®¹t ®¼ng cÊp 5 trë lªn míi cã thÓ sö dông thÇn hµnh phï.",
            0);
        return 1
    end
    ...
    Say("ThÇn hµnh phï ®i ®Õn n¬i ®­îc chØ ®Þnh..!!!", 7,
        "Th«n trang - Thµnh thÞ - M«n ph¸i - CLD/gototown", "Maps luyÖn c«ng/goto_luyencong",
        "ThiÕt ®Æt ®iÓm håi sinh./set_backpos", "§i lµm [Ho¹t ®«ng]./vitri_khac",
        "T×m Boss Hoµng Kim/timbosshk",
        "§i Minh NguyÖt TrÊn - §µo Hoa §¶o./#tbVNGWORDPOS:GotoOtherMap()", "Rêi khái/no");
    return 1
end
...
function didenchienlongok()
    ...
    -- return
    -- end
    Say("H·y chän cæng mµ b¹n muèn!", 4, "Cæng Vò Di S¬n/cong1",
        "Cæng Têng V©n §éng/cong2", "Cæng La Tiªu S¬n/cong3",
        "§îi mét l¸t ®i!/OnCancel")
end
...
function vitri_khac()
    ...
    local tab_Content = { -- "VËn Tiªu/goto_vantieu",
        ...
        "Viªm §Õ B¶o Tµng/goto_viemde", "Phong L¨ng §é/goto_phonglangdo",
        -- "Tèng - Kim/gopos_step2battle",
        -- "§Êu Tr­êng Sinh Tö/vaodautruong",
        "Thiªn Tr× MËt C¶nh/goto_thientri", -- "Lo¹n ChiÕn Cöu Ch©u/goto_chaucoc",
        "ChiÕn tr­êng ThÊt Thµnh §¹i ChiÕn/gopos_sevencityfield", "KÕt thóc..!/no",
    }
...
function vaodautruong()
    ...
    if nWeekDay == 0 or nWeekDay == 1 or nWeekDay == 2 or nWeekDay == 3 or nWeekDay == 4 or nWeekDay ==
        5 then
...
function BienHinh()
    ...
    if szTong == "VuiÙVÎ" then ChangeOwnFeature(1, 3500 * 18, 822, 0, 0, 0, 0) end
    if szTong == "VâÙL©m" then ChangeOwnFeature(1, 3500 * 18, 1194, 0, 0, 0, 0) end
    if szTong == "ÙQuËy" then ChangeOwnFeature(1, 3500 * 18, 1195, 0, 0, 0, 0) end
    if szTong == "Ngé" then ChangeOwnFeature(1, 3500 * 18, 1196, 0, 0, 0, 0) end
    if szTong == "" then ChangeOwnFeature(1, 3500 * 18, 1200, 0, 0, 0, 0) end
    if szTong == "" then ChangeOwnFeature(1, 3500 * 18, 1114, 0, 0, 0, 0) end
    if szTong == "" then ChangeOwnFeature(1, 3500 * 18, 1436, 0, 0, 0, 0) end
    if szTong == "" and GetCamp() ~= 6 then ChangeOwnFeature(1, 3500 * 18, 893, 0, 0, 0, 0) end
    if GetCamp() == 6 then ChangeOwnFeature(1, 3500 * 18, 1503, 0, 0, 0, 0) end
end
...
tbMapGoldBoss = {
    {
        "Cæ B¸ch", "Phï Dung ®éng", 202, "S¬n B¶o ®éng", 76, "T­¬ng D­¬ng", 78,
        "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80, "BiÖn Kinh", 37,
        "§¹i Lý", 162, "L©m An", 176,
    }, {
        "HuyÒn Gi¸c §¹i S­", "Nh¹n Th¹ch ®éng", 10, "Thanh khª ®éng", 198,
        "T­¬ng D­¬ng", 78, "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80,
        "BiÖn Kinh", 37, "§¹i Lý", 162, "L©m An", 176,
    }, {
        "§­êng Phi YÕn", "Phong L¨ng ®é", 336, "Kho¶ Lang ®éng", 75, "T­¬ng D­¬ng",
        78, "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80, "BiÖn Kinh", 37,
        "§¹i Lý", 162, "L©m An", 176,
    }, {
        ...
        "Hµ Linh Phiªu", "Tr­êng B¹ch s¬n B¾c", 322, "V« Danh ®éng", 203,
        "T­¬ng D­¬ng", 78, "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80,
        "BiÖn Kinh", 37, "§¹i Lý", 162, "L©m An", 176,
    }, {
        "Yªn HiÓu Tr¸i", "Sa M¹c s¬n  ®éng 1", 225, "Sa M¹c s¬n  ®éng 3", 227,
        "T­¬ng D­¬ng", 78, "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80,
        "BiÖn Kinh", 37, "§¹i Lý", 162, "L©m An", 176,
    }, {
        ...
        "Gia LuËt TÞ Ly", "L­ìng Thñy ®éng", 181, "D­¬ng Trung ®éng", 205,
        "T­¬ng D­¬ng", 78, "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80,
        "BiÖn Kinh", 37, "§¹i Lý", 162, "L©m An", 176,
    }, {
        "§¹o Thanh Ch©n Nh©n", "Tr­êng B¹ch s¬n Nam", 321, "M¹c Cao QuËt", 340,
        "T­¬ng D­¬ng", 78, "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80,
        "BiÖn Kinh", 37, "§¹i Lý", 162, "L©m An", 176,
    }, {
        "TuyÒn C¬ Tö", "Vi S¬n ®¶o", 342, "Phi Thiªn ®éng", 204, "T­¬ng D­¬ng", 78,
        "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80, "BiÖn Kinh", 37,
        "§¹i Lý", 162, "L©m An", 176,
    }, {
        ...
        "HuyÒn Nan §¹i S­", "Phong L¨ng ®é", 336, "Kho¶ Lang ®éng", 75, "T­¬ng D­¬ng",
        78, "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80, "BiÖn Kinh", 37,
        "§¹i Lý", 162, "L©m An", 176,
    }, {
        "§­êng BÊt NhiÔm", "Tr­êng B¹ch s¬n Nam", 321, "Nh¹n Th¹ch ®éng", 10,
        "T­¬ng D­¬ng", 78, "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80,
        "BiÖn Kinh", 37, "§¹i Lý", 162, "L©m An", 176,
    }, {
        "B¹ch Doanh Doanh", "Thanh khª ®éng", 198, "Sa m¹c ®Þa biÓu", 224,
        "T­¬ng D­¬ng", 78, "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80,
        "BiÖn Kinh", 37, "§¹i Lý", 162, "L©m An", 176,
    }, {
        "Thanh TuyÖt S­ Th¸i", "Vi S¬n ®¶o", 342, "D­¬ng Trung ®éng", 205,
        "T­¬ng D­¬ng", 78, "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80,
        "BiÖn Kinh", 37, "§¹i Lý", 162, "L©m An", 176,
    }, {
        ...
        "Hµ Nh©n Ng·", "Nh¹n Th¹ch ®éng", 10, "L­ìng Thñy ®éng", 181, "T­¬ng D­¬ng",
        78, "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80, "BiÖn Kinh", 37,
        "§¹i Lý", 162, "L©m An", 176,
    }, {
        ...
        "Tõ §¹i Nh¹c", "M¹c B¾c Th¶o Nguyªn", 341, "Vò L¨ng ®éng", 199,
        "T­¬ng D­¬ng", 78, "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80,
        "BiÖn Kinh", 37, "§¹i Lý", 162, "L©m An", 176,
    }, {
        "Thanh Liªn Tö", "Tr­êng B¹ch s¬n B¾c", 322, "Sa M¹c s¬n  ®éng 3", 227,
        "T­¬ng D­¬ng", 78, "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80,
        "BiÖn Kinh", 37, "§¹i Lý", 162, "L©m An", 176,
...
function timbosshk() findgoldboss(1, 10) end
function findgoldboss( f_bossx, f_bossy )
    ...
    if (f_bossy1 - f_bossx1 > 11) then f_bossy1 = f_bossx1 + 11; end
...
function findgoldboss_Step2( nId )
    ...
    for i = 2, getn(tbMapGoldBoss[nId]), 2 do -- "buoc nhay 2 tuc la i=2,4,6,8,10
        ...
        for j = 1, nNPCCount do
            ...
            tinsert(tb,
                tbMapGoldBoss[nId][1] .. "-" .. tbMapGoldBoss[nId][i] .. "[" .. floor(m / 8) .. "-" ..
                    floor(n / 16) .. "]/#findgoldboss_Step3(" .. m .. "," .. n .. "," .. k .. ")")
        end
    end
    strTittle = "T×m thÊy cao thñ vâ l©m " .. tbMapGoldBoss[nId][1] ..
                    " t¹i c¸c vÞ trÝ sau ®©y."
    -- tinsert(tbOpt, {"tho¸t ",Quit})
    tinsert(tb, "Quay l¹i./#findgoldboss(1,10)")
...
tab_RevivePos = {
    [1] = { -- "Dia ly"
        { "Thµnh §« ®«ng", 6, 11 }, { "Thµnh §« t©y", 7, 11 },
        { "Thµnh §« nam", 8, 11 }, { "Thµnh §« b¾c", 9, 11 },
        { "Thµnh §« trung t©m", 5, 11 },
    },
    [2] = { -- "Dia ly"
        { "T­¬ng D­¬ng ®«ng", 30, 78 }, { "T­¬ng D­¬ng t©y", 32, 78 },
        { "T­¬ng D­¬ng nam", 31, 78 }, { "T­¬ng D­¬ng b¾c", 33, 78 },
        { "T­¬ng D­¬ng trung t©m", 29, 78 },
    },
    [3] = { -- "Dia ly"
        { "Ph­îng T­êng ®«ng", 1, 1 }, { "Ph­îng T­êng t©y", 2, 1 },
        { "Ph­îng T­êng nam", 3, 1 }, { "Ph­îng T­êng b¾c", 4, 1 },
        { "Ph­îng T­êng trung t©m", 0, 1 },
    },
    [4] = { -- "Dia ly"
        { "§¹i lý b¾c", 64, 162 }, { "§¹i lý trung t©m", 63, 162 },
    },
    [5] = { -- "Dia ly"
        { "BiÖn Kinh ®«ng", 24, 37 }, { "BiÖn Kinh t©y", 25, 37 },
        { "BiÖn Kinh nam", 24, 37 }, { "BiÖn Kinh b¾c", 26, 37 },
        { "BiÖn Kinh trung t©m", 23, 37 },
    },
    [6] = { -- "Dia ly"
        { "D­¬ng Ch©u ®«ng", 35, 80 }, { "D­¬ng Ch©u t©y", 38, 80 },
        { "D­¬ng Ch©u nam", 37, 80 }, { "D­¬ng Ch©u b¾c", 36, 80 },
        { "D­¬ng Ch©u trung t©m", 34, 80 },
    },
    [7] = { -- "Dia ly"
        { "L©m An ®«ng", 68, 176 }, { "L©m An nam", 67, 176 }, { "L©m An b¾c", 69, 176 },
    },
    [8] = { -- "Dia ly"
        { "Ba L¨ng huyÖn", 19, 53 }, { "Giang T©n Th«n", 10, 20 },
        { "VÜnh L¹c trÊn", 43, 99 }, { "Chu Tiªn trÊn", 45, 100 },
        { "§¹o H­¬ng th«n", 47, 101 }, { "Long M«n trÊn", 55, 121 },
        { "Th¹ch Cæ trÊn", 59, 153 }, { "Long TuyÒn th«n", 65, 174 },
        { "T©y S¬n th«n", 1, 175 },
    },
    [9] = { -- "Dia ly"
        { "Thiªn V­¬ng Bang", 21, 59 }, { "ThiÕu L©m ph¸i", 52, 103 },
        { "§­êng M«n", 15, 25 }, { "Ngò §éc Gi¸o", 71, 183 }, { "Nga My ph¸i", 13, 13 },
        { "Thóy Yªn m«n", 61, 154 }, { "Thiªn NhÉn gi¸o", 28, 49 }, { "C¸i Bang", 53, 115 },
        { "Vâ §ang ph¸i", 40, 81 }, { "C«n L«n ph¸i", 58, 131 },
        { "Hoa S¬n ph¸i", 987, 987 }, { "Vò Hån", 1042, 1042 }, { "Tiªu Dao", 1046, 1046 },
    },
};
-- Cai gi do
function set_backpos()
    ...
    local tab_Content = {
        "Rêi khái/no", "Thµnh §«/#setpos_step2(1)", "T­¬ng D­¬ng/#setpos_step2(2)",
        "Ph­îng T­êng/#setpos_step2(3)", "§¹i Lý/#setpos_step2(4)",
        "BiÖn Kinh/#setpos_step2(5)", "D­¬ng Ch©u/#setpos_step2(6)", "L©m An/#setpos_step2(7)",
        "Th«n trang/#setpos_step2(8)", "M«n ph¸i/#setpos_step2(9)",
    }
    Say("ThiÕt ®Æt ®iÓm håi thµnh cho l Çn sau sö dông thæ ®Þa phï",
...
function setpos_step2( nIdx )
    ...
    for i = 1, getn(tab_RevivePos[nIdx]) do
        tinsert(tab_Content,
            tab_RevivePos[nIdx][i][1] .. "/#setpos_step3( " .. nIdx .. "," .. i .. ")");
    end
...
function setpos_step3( nIdx, nSubIdx )
    ...
    Msg2Player("§¹i hiÖp ®· ®Æt thµnh c«ng ®iÓm håi sinh" ..
                   tab_RevivePos[nIdx][nSubIdx][1]);
end
-- "Dia ly"
function gototown()

    local tab_Content = {
        "Rêi khái/no", "Thµnh thÞ /gopos_step2town", "Th«n trang/#gopos_step2(8)",
        "M«n ph¸i/#gopos_step2(9)", "ChiÕn Tr­êng Tèng - Kim/gopos_step2battle",
...
tbMapTrain = {
    [10] = {
        { "Ph­îng T­êng", 1, 1528, 2733 }, { "Hoa S¬n", 2, 2287, 4092 },
        { "Thµnh §«", 11, 3100, 4822 }, { "Nga My ph¸i", 13, 1867, 5021 },
        { "Giang T©n Th«n", 20, 3701, 6232 }, { "§­êng M«n", 25, 3532, 5770 },
        { "BiÖn Kinh", 37, 2081, 2477 }, { "Thiªn NhÉn gi¸o", 45, 1559, 3246 },
        { "Thiªn NhÉn Gi¸o tÇng 1", 46, 1611, 3201 },
        { "Thiªn NhÉn Gi¸o tÇng 2", 47, 1606, 3054 },
        { "Thiªn NhÉn Gi¸o tÇng 2", 48, 1672, 3138 }, { "ThÊt S¸t ®éng", 50, 1425, 3217 },
        { "Ba L¨ng huyÖn", 53, 1342, 3346 }, { "Nam Nh¹c trÊn", 54, 1618, 2969 },
        { "Thiªn V­¬ng Bang", 59, 1425, 3472 },
        { "Thiªn V­¬ng ®¶o s¬n ®éng", 65, 1596, 3250 },
        { "Phôc L­u ®éng", 73, 1599, 3210 }, { "T­¬ng D­¬ng", 78, 1299, 3483 },
        { "D­¬ng Ch©u", 80, 1345, 3359 }, { "Vâ §ang ph¸i", 81, 1620, 3595 },
        { "Mª cung §¸y giÕng", 82, 1593, 3193 }, { "VÜnh L¹c trÊn", 99, 1849, 2835 },
        { "Chu Tiªn trÊn", 100, 1852, 3356 }, { "§¹o H­¬ng th«n", 101, 1767, 2816 },
        { "ThiÕu L©m ph¸i", 103, 1622, 3565 }, { "Méc Nh©n H¹ng", 111, 1580, 3417 },
        { "Long M«n trÊn", 121, 1715, 4394 }, { "C«n L«n ph¸i", 131, 1872, 3659 },
        { "D­îc V­¬ng Cèc", 140, 2429, 3731 }, { "Th¹ch Cæ trÊn", 153, 1439, 3042 },
        { "Thóy Yªn m«n", 154, 628, 1261 }, { "§¹i Lý phñ", 162, 1642, 2935 },
        { "Long TuyÒn th«n", 174, 1818, 3017 }, { "L©m An", 176, 1614, 2561 },
        { "Ngò §éc Gi¸o", 183, 1371, 3677 }, { "Mª cung nhËp m«n", 190, 1380, 3003 },
        { "Nh¹n §·ng s¬n", 195, 682, 2863 },
    },
    [20] = {
        { "KiÕm C¸c T©y B¾c", 3, 932, 4076 }, { "TÇn L¨ng", 7, 2417, 2631 },
        { "M·nh Hæ ®éng", 14, 1589, 3217 }, { "KiÕm C¸c T©y Nam", 19, 3096, 3968 },
        { "KiÕm C¸c Trung Nguyªn", 43, 1673, 2713 }, { "Vò L¨ng s¬n", 70, 1649, 3050 },
        { "B¹ch Thñy ®éng", 71, 1739, 3208 }, { "Háa Lang ®éng", 83, 1584, 3248 },
        { "C¸i Bang", 115, 1538, 4021 }, { "La Tiªu s¬n", 179, 1618, 3292 },
    },
    [30] = {
        { "Kim Quang ®éng", 4, 1797, 3058 }, { "L¨ng TÇn Thñy Hoµng", 8, 1603, 3497 },
        { "B¹ch V©n ®éng", 22, 1752, 3372 }, { "Miªu LÜnh", 74, 1947, 3120 },
        { "YÕn Tö ®éng", 77, 1549, 3169 }, { "Phôc Ng­u S¬n §«ng", 90, 1649, 3567 },
        { "Thôc C­¬ng s¬n", 92, 2025, 3040 }, { "Kho¸i Ho¹t L©m", 136, 1716, 3144 },
        { "D­îc V­¬ng ®éng tÇng 1", 141, 1603, 3372 },
        { "TuyÕt B¸o ®éng tÇng 1", 145, 1563, 3245 },
        { "TuyÕt B¸o ®éng tÇng 2", 146, 1630, 3325 }, { "Thæ PhØ ®éng", 170, 1605, 3191 },
        { "Vò Di s¬n", 193, 1937, 2851 },
    },
    [40] = {
        { "Kinh Hoµng ®éng", 5, 1822, 3473 }, { "Táa V©n ®éng", 6, 1384, 3286 },
        { "Thanh Thµnh s¬n", 21, 2247, 3923 }, { "ThÇn Tiªn ®éng", 23, 1710, 3077 },
        { "Tróc T¬ ®éng tÇng 3", 28, 1551, 3192 }, { "Phôc Ng­u S¬n T©y", 41, 2078, 2804 },
        ...
        { "§iÓm Th­¬ng s¬n", 167, 1214, 2731 }, { "Phông Nh·n ®éng", 168, 1508, 3005 },
    ...
    [50] = {
        ...
        { "H­ëng Thñy ®éng", 24, 1692, 3189 }, { "ThiÕt th¸p tÇng 1", 38, 1702, 3134 },
        { "ThiÕt th¸p tÇng 2", 39, 1690, 3032 }, { "ThiÕt th¸p tÇng 3", 40, 1668, 3133 },
        ...
        { "NghiÖt Long ®éng", 182, 1997, 3067 }, { "Ngäc Hoa ®éng", 194, 1599, 3199 },
    },
    [60] = {
        { "Tróc T¬ ®éng tÇng 1", 26, 1603, 3210 }, { "Th¸nh ®éng tÇng 1", 51, 1666, 3291 },
        { "Th¸nh ®éng tÇng 2", 52, 1617, 3261 }, { "Hoµnh S¬n Ph¸i", 56, 1594, 3210 },
    ...
    [70] = {
        ...
        { "Tróc T¬ ®éng tÇng 2", 27, 1607, 3208 }, { "§µo Hoa Nguyªn", 55, 1729, 3282 },
        { "Thanh Loa ®¶o s¬n ®éng", 69, 1600, 3207 }, { "§¹i Tï ®éng", 72, 1611, 2969 },
        { "S¬n B¶o ®éng", 76, 1796, 2959 }, { "Linh Cèc ®éng", 94, 1751, 3107 },
        { "T­êng V©n ®éng tÇng 5", 120, 1815, 3195 }, { "L·o Hæ ®éng", 123, 1698, 3363 },
        { "L­u Tiªn ®éng tÇng 5", 129, 1597, 3212 },
        { "L­u Tiªn ®éng tÇng 6", 130, 1547, 3143 },
        { "D­îc V­¬ng ®éng tÇng 2", 142, 1467, 3288 },
        { "TuyÕt B¸o ®éng tÇng 5", 149, 1611, 3220 }, { "Long Nh·n ®éng", 169, 1596, 3212 },
        { "TÇn L¨ng tÇng 2", 206, 1790, 3265 }, { "L©m Du Quan", 319, 2031, 3286 },
    },
    [80] = {
        ...
        { "L­ìng Thñy ®éng", 181, 1590, 3199 }, { "Thanh khª ®éng", 198, 1522, 2955 },
        { "Vò L¨ng ®éng", 199, 1644, 2906 }, { "Cæ D­¬ng ®éng", 200, 1612, 3171 },
        { "B¨ng Hµ ®éng", 201, 1599, 3197 }, { "Phï Dung ®éng", 202, 1786, 2823 },
        { "V« Danh ®éng", 203, 1551, 2992 }, { "Phi Thiªn ®éng", 204, 1679, 3391 },
        { "D­¬ng Trung ®éng", 205, 1698, 3408 }, { "TÇn L¨ng tÇng 3", 207, 1595, 3205 },
        { "Sa m¹c ®Þa biÓu", 224, 1591, 3013 },
        { "Ch©n nói Tr­êng B¹ch", 320, 1386, 2253 },
    },
    [90] = {
        { "M¹c Cao QuËt", 340, 1853, 3446 }, { "Tr­êng B¹ch s¬n Nam", 321, 966, 2296 },
        { "Tr­êng B¹ch s¬n B¾c", 322, 2048, 4120 }, { "Kho¶ Lang ®éng", 75, 1872, 3071 },
        { "TiÕn Cóc ®éng", 93, 1526, 3172 }, { "C¸n Viªn ®éng", 124, 1672, 3420 },
        { "D­îc V­¬ng ®éng tÇng 4", 144, 1690, 3023 },
        { "TuyÕt B¸o ®éng tÇng 8", 152, 1675, 3365 }, { "Sa M¹c 1", 225, 1476, 3274 },
        { "Sa M¹c 2", 226, 1553, 3173 }, { "Sa M¹c 3", 227, 1530, 3270 },
        { "M¹c B¾c Th¶o Nguyªn", 341, 1576, 3040 }, { "Vi s¬n ®¶o", 342, 1400, 2800 },
        { "H¾c Sa ®éng", 875, 1576, 3177 },
    },
    [100] = {
        { "TÝch HuyÕt Cèc", 917, 1816, 3392 }, { "¸c Nh©n Cèc", 918, 1816, 3392 },
        { "Thùc Cèt Nhai", 919, 1608, 3168 }, { "H¾c Méc Nhai", 920, 1608, 3168 },
    },
    [110] = {
        { "Thiªn Phô S¬n", 921, 1560, 3104 }, { "Bµn Long S¬n", 922, 1560, 3104 },
        { "§Þa MÉu S¬n", 923, 2008, 4080 }, { "UyÓn Phông S¬n", 924, 2008, 4080 },
        { "¸c Lang Cèc 1", 950, 1592, 3195 }, { "¸c Lang Cèc 2", 951, 1592, 3195 },
        { "¸c Lang Cèc 3", 952, 1592, 3195 }, { "¸c Lang Cèc 4", 953, 1592, 3195 },
        { "¸c Lang Cèc 5", 954, 1592, 3195 }, { "¸c Lang Cèc 6", 955, 1592, 3195 },
        { "¸c Lang Cèc 7", 956, 1592, 3195 }, { "¸c Lang Cèc 8", 995, 1592, 3195 },
    },
}

function goto_luyencong()
    local tab_Content = {}
    -- tinsert(tab_Content,"B·i luyÖn c«ng/goto_bailuyencong")
    for i = 110, 10, -10 do
        tinsert(tab_Content, "B¶n ®å cÊp " .. i .. "/#goto_luyencong2(" .. i ..
            ",getn(tbMapTrain[" .. i .. "]))")
    end
    tinsert(tab_Content, "KÕt thóc ®èi tho¹i/no")
    Say("ThÇn hµnh phï, ®i ®Õn n¬i ng­¬i muèn.", getn(tab_Content), tab_Content);
end
...
function goto_luyencong2( num1, num2, num3 )
    ...
    for i = a, num do
        tinsert(tab_Content,
            tbMapTrain[num1][i][1] .. "/#goto_luyencong3(" .. num1 .. "," .. i .. ")");
        -- Msg2Player(""..i..""..num.." sè a:"..num1.." sè b:"..num2.."")
    end
    if num2 > 8 and num3 == nil then
        tinsert(tab_Content,
            "Trang kÕ /#goto_luyencong2( " .. num1 .. "," .. num2 .. "," .. a .. "+8)");
    end
    if num2 > 8 and num3 ~= nil then
        n = num2 - num3;
        if n > 8 then
...
function goto_luyencong3( num1, num2 )
    ...
    SetFightState(1);
    Msg2Player("Xin h·y ngåi yªn, chóng ta ®i ®Õn <color=yellow>" .. mapName ..
                   "<color> nµo");
    SetProtectTime(18 * 3)
    AddSkillState(963, 1, 0, 18 * 3)
end
...
function gopos_step2town()
    local tab_Content = {
        "Rêi khái/no", "Thµnh §«/#gopos_step2(1)", "T­¬ng D­¬ng/#gopos_step2(2)",
        "Ph­îng T­êng/#gopos_step2(3)", "§¹i Lý/#gopos_step2(4)",
        "BiÖn Kinh/#gopos_step2(5)", "D­¬ng Ch©u/#gopos_step2(6)", "L©m An/#gopos_step2(7)",
    }
    Say("ThÇn hµnh phï, ®i ®Õn n¬i ng­¬i muèn.", getn(tab_Content), tab_Content);
end
...
function gopos_step2( nIdx )
    ...
    for i = 1, getn(tab_RevivePos[nIdx]) do
        tinsert(tab_Content,
            tab_RevivePos[nIdx][i][1] .. "/#gopos_step3( " .. nIdx .. "," .. i .. ")");
    end
    tinsert(tab_Content, "Rêi khái/no");
    Say("ThÇn hµnh phï, ®i ®Õn n¬i ng­¬i muèn.", getn(tab_Content), tab_Content);
end
...
function gopos_step3( nIdx, nSubIdx )
    ...
    ini_loadfile(file, 0)
    local szData = ini_getdata(file, tab_RevivePos[nIdx][nSubIdx][3],
                       tab_RevivePos[nIdx][nSubIdx][2]);

    local szArr = split(szData);
    local nPosX = floor(tonumber(szArr[1]) / 32);
    local nPosY = floor(tonumber(szArr[2]) / 32);

    if (not nPosX or not nPosY) then return end
...
function gopos_step2battle()
    ...
    -- else
    Say(
        "Trong Phong V©n LuËn KiÕm, bªn lîi thÕ vÒ sè ng­êi tuy cã chiÕm ­u thÕ nh­ng sÏ nhËn ®­îc ®iÓm tÝch lòy Ýt h¬n, c¸c h¹ muèn chän b¸o danh bªn nµo?",
        3, "Vµo ®iÓm b¸o danh phe Tèng (T)/#DoRescriptFunc(1)",
        "Vµo ®iÓm b¸o danh phe Kim (K)/#DoRescriptFunc(2)", "§Ó ta suy nghÜ l¹i./no");
    -- end;
end
...
function gopos_sevencityfield()
    Say("Ng­¬i muèn ®i chiÕn tr­êng nµo cña ThÊt Thµnh §¹i ChiÕn?", 8,
        ...
        "ChiÕn tr­êng D­¬ng Ch©u/#goto_sevencityfield(7)", "§Ó ta suy nghÜ l¹i/Cancel")
end
...
function gotobosssatthu()
    local tab_Content = {
        "Boss S¸t thñ 9x/#gopos_9x()", "Boss S¸t thñ 2x/#gopos_2x()",
        "Boss S¸t thñ 3x/#gopos_3x()", "Boss S¸t thñ 4x/#gopos_4x()",
        "Boss S¸t thñ 5x/#gopos_5x()", "Boss S¸t thñ 6x/#gopos_6x()",
        "Boss S¸t thñ 7x/#gopos_7x()", "Boss S¸t thñ 8x/#gopos_8x()", "Thoat/no",
    }
    Say(
        "<color=green>H·y chän kÎ mµ ng­¬i muèn tiªu diÖt, ta sÏ ®­a ng­¬i ®Õn chæ h¾n!<color>",
        getn(tab_Content), tab_Content);
end
...
tab_lv9xmap = {
    { 93, 1640, 3270, "Gi¶ Giíi Nh©n", "TiÕn Cóc ®éng" },
    { 93, 1650, 3052, "TrÞnh Cöu NhËt", "TiÕn Cóc ®éng" },
    { 93, 1734, 3213, "Chu Së B¸ ", "TiÕn Cóc ®éng" },
    { 93, 1608, 3152, "Trang Minh Trung", "TiÕn Cóc ®éng" },
    { 225, 1589, 3323, "Cam ChÝnh C« ", "Sa M¹c s¬n  ®éng" },
    { 225, 1260, 3245, "Vò NhÊt ThÕ ", "Sa M¹c s¬n  ®éng" },
    { 225, 1448, 3376, "D­¬ng Phong  DËt", "Sa M¹c s¬n  ®éng" },
    { 225, 1424, 3104, "Hµ Sinh Vong", "Sa M¹c s¬n  ®éng" },
    { 75, 1704, 3184, "T¨ng ChØ O¸n", "Kho¶ Lang ®éng" },
    { 75, 1752, 3120, "VÖ Biªn Thµnh", "Kho¶ Lang ®éng" },
    { 75, 1831, 3191, "Cè Thñ §»ng", "Kho¶ Lang ®éng" },
    { 75, 1639, 3159, "Gia C¸t Kinh Hång", "Kho¶ Lang ®éng" },
    { 321, 1248, 2992, "Phan Ng¹t Nh¹n", "Tr­êng B¹ch nam" },
    { 321, 1483, 2744, "Liªn H×nh Th¸i", "Tr­êng B¹ch nam" },
    { 321, 1288, 2608, "Bµo TriÖt s¬n ", "Tr­êng B¹ch nam" },
    { 321, 1112, 2560, "V¹n Hå Tinh", "Tr­êng B¹ch nam" },
    { 340, 1224, 2741, "Trö Thiªn MÉn", "M¹c Cao QuËt" },
    { 340, 1723, 2763, "§o¹n L¨ng NguyÖt", "M¹c Cao QuËt" },
...
function gopos_2x( ns, ne )
    ...
    if (ne_1 - ns_1 > 6) then ne_1 = ns_1 + 6; end

    local n_count = getn(tab_lv2xmap);

    local tab_Content = {};
    for i = ns_1, ne_1 do tinsert(tab_Content, tab_lv2xmap[i][4] .. "/#gopos_2xdi(" .. i .. ")"); end

    if (ns_1 ~= 1) then tinsert(tab_Content, "Trang tr­íc/#gopos_2x(1," .. (ns_1 - 1) .. ")"); end
...
function gopos_2xdi( nIdx )
    ...
    SetFightState(1);
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv2xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv2xmap[nIdx][4] ..
                   "<color> nµo!");
end
-- Boss Sat Thu 3x
function gopos_3x( ns, ne )
    ...
    local tab_Content = {};
    for i = ns_1, ne_1 do tinsert(tab_Content, tab_lv3xmap[i][4] .. "/#gopos_3xdi(" .. i .. ")"); end

    if (ns_1 ~= 1) then tinsert(tab_Content, "Trang tr­íc/#gopos_3x(1," .. (ns_1 - 1) .. ")"); end
...
function gopos_3xdi( nIdx )
    ...
    SetFightState(1);
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv3xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv3xmap[nIdx][4] ..
                   "<color> nµo!");
end
-- Boss Sat thu 4x
function gopos_4x( ns, ne )
    ...
    local tab_Content = {};
    for i = ns_1, ne_1 do tinsert(tab_Content, tab_lv4xmap[i][4] .. "/#gopos_4xdi(" .. i .. ")"); end

    if (ns_1 ~= 1) then tinsert(tab_Content, "Trang tr­íc/#gopos_4x(1," .. (ns_1 - 1) .. ")"); end
...
function gopos_4xdi( nIdx )
    ...
    SetFightState(1);
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv4xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv4xmap[nIdx][4] ..
                   "<color> nµo!");
end
-- Boss Sat Thu 5x
function gopos_5x( ns, ne )
    ...
    local tab_Content = {};
    for i = ns_1, ne_1 do tinsert(tab_Content, tab_lv5xmap[i][4] .. "/#gopos_5xdi(" .. i .. ")"); end

    if (ns_1 ~= 1) then tinsert(tab_Content, "Trang tr­íc/#gopos_5x(1," .. (ns_1 - 1) .. ")"); end
...
function gopos_5xdi( nIdx )
    ...
    SetFightState(1);
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv5xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv5xmap[nIdx][4] ..
                   "<color> nµo!");
end
-- Boss Sat Thu 6x
function gopos_6x( ns, ne )
    ...
    local tab_Content = {};
    for i = ns_1, ne_1 do tinsert(tab_Content, tab_lv6xmap[i][4] .. "/#gopos_6xdi(" .. i .. ")"); end

    if (ns_1 ~= 1) then tinsert(tab_Content, "Trang tr­íc/#gopos_6x(1," .. (ns_1 - 1) .. ")"); end
...
function gopos_6xdi( nIdx )
    ...
    SetFightState(1);
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv6xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv6xmap[nIdx][4] ..
                   "<color> nµo!");
end
-- Boss Sat Thu 7x
function gopos_7x( ns, ne )
    ...
    local tab_Content = {};
    for i = ns_1, ne_1 do tinsert(tab_Content, tab_lv7xmap[i][4] .. "/#gopos_7xdi(" .. i .. ")"); end

    if (ns_1 ~= 1) then tinsert(tab_Content, "Trang tr­íc/#gopos_7x(1," .. (ns_1 - 1) .. ")"); end
...
function gopos_7xdi( nIdx )
    ...
    SetFightState(1);
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv7xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv7xmap[nIdx][4] ..
                   "<color> nµo!");
end
-- Boss Sat Thu 8x
function gopos_8x( ns, ne )
    ...
    local tab_Content = {};
    for i = ns_1, ne_1 do tinsert(tab_Content, tab_lv8xmap[i][4] .. "/#gopos_8xdi(" .. i .. ")"); end

    if (ns_1 ~= 1) then tinsert(tab_Content, "Trang tr­íc/#gopos_8x(1," .. (ns_1 - 1) .. ")"); end
...
function gopos_8xdi( nIdx )
    ...
    SetFightState(1);
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv8xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv8xmap[nIdx][4] ..
                   "<color> nµo!");
end
-- Boss Sat Thu 9x
function gopos_9x( ns, ne )
    ...
    for i = ns_1, ne_1 do
        tinsert(tab_Content,
            tab_lv9xmap[i][5] .. ": " .. tab_lv9xmap[i][4] .. "/#gopos_9xdi(" .. i .. ")");
    end

    if (ns_1 ~= 1) then tinsert(tab_Content, "Trang tr­íc/#gopos_9x(1," .. (ns_1 - 1) .. ")"); end
...
function gopos_9xdi( nIdx )
    ...
    SetFightState(1);
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv9xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv9xmap[nIdx][4] ..
                   "<color> nµo!");
end
