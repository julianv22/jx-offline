...
function main(sel)
    ...
    if (nSubWorldID == 44 or nSubWorldID == 197 or nSubWorldID == 208 or nSubWorldID == 209 or nSubWorldID == 210 or
        nSubWorldID == 211 or nSubWorldID == 212 or (nSubWorldID >= 213 and nSubWorldID <= 223) or nSubWorldID == 336 or
        nSubWorldID == 341 or nSubWorldID == 342 or nSubWorldID == 175 or nSubWorldID == 337 or nSubWorldID == 338 or
    ...
    Say("ThÇn hµnh phï ®i ®Õn n¬i ®­îc chØ ®Þnh..!!!", 7,
        ...
        "T×m Boss Hoµng Kim/timbosshk", "§i Minh NguyÖt TrÊn - §µo Hoa §¶o./#tbVNGWORDPOS:GotoOtherMap()",
        "Rêi khái/no");
    return 1
end
...
function didenchienlongok()
    ...
    -- return
    -- end
    Say("H·y chän cæng mµ b¹n muèn!", 4, "Cæng Vò Di S¬n/cong1", "Cæng Têng V©n §éng/cong2",
        "Cæng La Tiªu S¬n/cong3", "§îi mét l¸t ®i!/OnCancel")
end
...
function vitri_khac()
    ...
    "Boss s¸t thñ/gotobosssatthu", "V­ît ¶i/goto_satthu", "TÝn Sø/goto_tinsu", "KiÕm Gia Mª Cung/goto_kiemgia",
    "ThÝ LuyÖn §­êng/goto_thiluyenduong", "Viªm §Õ B¶o Tµng/goto_viemde", "Phong L¨ng §é/goto_phonglangdo",
...
tbMapGoldBoss = {{"Cæ B¸ch", "Phï Dung ®éng", 202, "S¬n B¶o ®éng", 76, "T­¬ng D­¬ng", 78,
                 ...
                 {"HuyÒn Nan §¹i S­", "Phong L¨ng ®é", 336, "Kho¶ Lang ®éng", 75, "T­¬ng D­¬ng", 78,
                  "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80, "BiÖn Kinh", 37, "§¹i Lý", 162,
                  "L©m An", 176},
                 {"§­êng BÊt NhiÔm", "Tr­êng B¹ch s¬n Nam", 321, "Nh¹n Th¹ch ®éng", 10, "T­¬ng D­¬ng",
                  78, "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80, "BiÖn Kinh", 37, "§¹i Lý", 162,
                  "L©m An", 176},
                 {"B¹ch Doanh Doanh", "Thanh khª ®éng", 198, "Sa m¹c ®Þa biÓu", 224, "T­¬ng D­¬ng", 78,
                  "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80, "BiÖn Kinh", 37, "§¹i Lý", 162,
                  "L©m An", 176},
                 {"Thanh TuyÖt S­ Th¸i", "Vi S¬n ®¶o", 342, "D­¬ng Trung ®éng", 205, "T­¬ng D­¬ng", 78,
                  "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80, "BiÖn Kinh", 37, "§¹i Lý", 162,
                  "L©m An", 176},
                 ...
                 {"Thanh Liªn Tö", "Tr­êng B¹ch s¬n B¾c", 322, "Sa M¹c s¬n  ®éng 3", 227, "T­¬ng D­¬ng",
                  78, "Ph­îng T­êng", 1, "Thµnh §«", 11, "D­¬ng Ch©u", 80, "BiÖn Kinh", 37, "§¹i Lý", 162,
                  "L©m An", 176} -- {"Thanh TuyÖt S­ Th¸i","Sa M¹c s¬n  ®éng 1",225,"Sa M¹c s¬n  ®éng 3",227,"T­¬ng D­¬ng",78,"Ph­îng T­êng",1,"Thµnh §«",11,"D­¬ng Ch©u",80,"BiÖn Kinh",37,"§¹i Lý",162,"L©m An",176},
...
tab_RevivePos = {
    [1] = { -- "Dia ly"
    {"Thµnh §« ®«ng", 6, 11}, {"Thµnh §« t©y", 7, 11}, {"Thµnh §« nam", 8, 11}, {"Thµnh §« b¾c", 9, 11},
    {"Thµnh §« trung t©m", 5, 11}},
    [2] = { -- "Dia ly"
    {"T­¬ng D­¬ng ®«ng", 30, 78}, {"T­¬ng D­¬ng t©y", 32, 78}, {"T­¬ng D­¬ng nam", 31, 78},
    {"T­¬ng D­¬ng b¾c", 33, 78}, {"T­¬ng D­¬ng trung t©m", 29, 78}},
    [3] = { -- "Dia ly"
    {"Ph­îng T­êng ®«ng", 1, 1}, {"Ph­îng T­êng t©y", 2, 1}, {"Ph­îng T­êng nam", 3, 1},
    {"Ph­îng T­êng b¾c", 4, 1}, {"Ph­îng T­êng trung t©m", 0, 1}},
    [4] = { -- "Dia ly"
    {"§¹i lý b¾c", 64, 162}, {"§¹i lý trung t©m", 63, 162}},
    [5] = { -- "Dia ly"
    {"BiÖn Kinh ®«ng", 24, 37}, {"BiÖn Kinh t©y", 25, 37}, {"BiÖn Kinh nam", 24, 37}, {"BiÖn Kinh b¾c", 26, 37},
    {"BiÖn Kinh trung t©m", 23, 37}},
    [6] = { -- "Dia ly"
    {"D­¬ng Ch©u ®«ng", 35, 80}, {"D­¬ng Ch©u t©y", 38, 80}, {"D­¬ng Ch©u nam", 37, 80},
    {"D­¬ng Ch©u b¾c", 36, 80}, {"D­¬ng Ch©u trung t©m", 34, 80}},
    [7] = { -- "Dia ly"
    {"L©m An ®«ng", 68, 176}, {"L©m An nam", 67, 176}, {"L©m An b¾c", 69, 176}},
    [8] = { -- "Dia ly"
    {"Ba L¨ng huyÖn", 19, 53}, {"Giang T©n Th«n", 10, 20}, {"VÜnh L¹c trÊn", 43, 99},
    {"Chu Tiªn trÊn", 45, 100}, {"§¹o H­¬ng th«n", 47, 101}, {"Long M«n trÊn", 55, 121},
    {"Th¹ch Cæ trÊn", 59, 153}, {"Long TuyÒn th«n", 65, 174}, {"T©y S¬n th«n", 1, 175}},
    [9] = { -- "Dia ly"
    {"Thiªn V­¬ng Bang", 21, 59}, {"ThiÕu L©m ph¸i", 52, 103}, {"§­êng M«n", 15, 25},
    {"Ngò §éc Gi¸o", 71, 183}, {"Nga My ph¸i", 13, 13}, {"Thóy Yªn m«n", 61, 154},
    {"Thiªn NhÉn gi¸o", 28, 49}, {"C¸i Bang", 53, 115}, {"Vâ §ang ph¸i", 40, 81}, {"C«n L«n ph¸i", 58, 131},
...
function set_backpos()
    ...
    local tab_Content = {"Rêi khái/no", "Thµnh §«/#setpos_step2(1)", "T­¬ng D­¬ng/#setpos_step2(2)",
...
function gototown()
    ...
    local tab_Content = {"Rêi khái/no", "Thµnh thÞ /gopos_step2town", "Th«n trang/#gopos_step2(8)",
...
tbMapTrain = {
    [10] = {{"Ph­îng T­êng", 1, 1528, 2733}, {"Hoa S¬n", 2, 2287, 4092}, {"Thµnh §«", 11, 3100, 4822},
            {"Nga My ph¸i", 13, 1867, 5021}, {"Giang T©n Th«n", 20, 3701, 6232}, {"§­êng M«n", 25, 3532, 5770},
            {"BiÖn Kinh", 37, 2081, 2477}, {"Thiªn NhÉn gi¸o", 45, 1559, 3246},
            {"Thiªn NhÉn Gi¸o tÇng 1", 46, 1611, 3201}, {"Thiªn NhÉn Gi¸o tÇng 2", 47, 1606, 3054},
            {"Thiªn NhÉn Gi¸o tÇng 2", 48, 1672, 3138}, {"ThÊt S¸t ®éng", 50, 1425, 3217},
            {"Ba L¨ng huyÖn", 53, 1342, 3346}, {"Nam Nh¹c trÊn", 54, 1618, 2969},
            {"Thiªn V­¬ng Bang", 59, 1425, 3472}, {"Thiªn V­¬ng ®¶o s¬n ®éng", 65, 1596, 3250},
            ...
            {"Long TuyÒn th«n", 174, 1818, 3017}, {"L©m An", 176, 1614, 2561}, {"Ngò §éc Gi¸o", 183, 1371, 3677},
            {"Mª cung nhËp m«n", 190, 1380, 3003}, {"Nh¹n §·ng s¬n", 195, 682, 2863}},
    [20] = {{"KiÕm C¸c T©y B¾c", 3, 932, 4076}, {"TÇn L¨ng", 7, 2417, 2631}, {"M·nh Hæ ®éng", 14, 1589, 3217},
            {"KiÕm C¸c T©y Nam", 19, 3096, 3968}, {"KiÕm C¸c Trung Nguyªn", 43, 1673, 2713},
            {"Vò L¨ng s¬n", 70, 1649, 3050}, {"B¹ch Thñy ®éng", 71, 1739, 3208},
            {"Háa Lang ®éng", 83, 1584, 3248}, {"C¸i Bang", 115, 1538, 4021}, {"La Tiªu s¬n", 179, 1618, 3292}},
    [30] = {{"Kim Quang ®éng", 4, 1797, 3058}, {"L¨ng TÇn Thñy Hoµng", 8, 1603, 3497},
            {"B¹ch V©n ®éng", 22, 1752, 3372}, {"Miªu LÜnh", 74, 1947, 3120}, {"YÕn Tö ®éng", 77, 1549, 3169},
            {"Phôc Ng­u S¬n §«ng", 90, 1649, 3567}, {"Thôc C­¬ng s¬n", 92, 2025, 3040},
            {"Kho¸i Ho¹t L©m", 136, 1716, 3144}, {"D­îc V­¬ng ®éng tÇng 1", 141, 1603, 3372},
            {"TuyÕt B¸o ®éng tÇng 1", 145, 1563, 3245}, {"TuyÕt B¸o ®éng tÇng 2", 146, 1630, 3325},
            {"Thæ PhØ ®éng", 170, 1605, 3191}, {"Vò Di s¬n", 193, 1937, 2851}},
    [40] = {{"Kinh Hoµng ®éng", 5, 1822, 3473}, {"Táa V©n ®éng", 6, 1384, 3286},
            {"Thanh Thµnh s¬n", 21, 2247, 3923}, {"ThÇn Tiªn ®éng", 23, 1710, 3077},
            {"Tróc T¬ ®éng tÇng 3", 28, 1551, 3192}, {"Phôc Ng­u S¬n T©y", 41, 2078, 2804},
            {"Mª cung Kª Qu¸n ®éng", 91, 1806, 2858}, {"MËt thÊt ThiÕu L©m", 113, 1675, 3361},
            {"Hoµng Hµ Nguyªn §Çu", 122, 1612, 3328}, {"KiÕn TÝnh Phong s¬n ®éng", 135, 1748, 3198},
            {"§iÓm Th­¬ng s¬n", 167, 1214, 2731}, {"Phông Nh·n ®éng", 168, 1508, 3005},
            {"§iÓm Th­¬ng ®éng tÇng 1", 171, 1532, 3130}, {"§iÓm Th­¬ng ®éng tÇng 2", 172, 1586, 3223},
            {"§iÓm Th­¬ng ®éng tÇng 3", 173, 1353, 3102}, {"Long Cung ®éng", 180, 1509, 3106}},
    [50] = {{"§Þa ®¹o hËu viÖn TÝn T­íng tù", 12, 1589, 3188}, {"H­ëng Thñy ®éng", 24, 1692, 3189},
            {"ThiÕt th¸p tÇng 1", 38, 1702, 3134}, {"ThiÕt th¸p tÇng 2", 39, 1690, 3032},
            {"ThiÕt th¸p tÇng 3", 40, 1668, 3133}, {"Thiªn T©m ®éng", 42, 1648, 3119},
            {"§¸y §éng §×nh hå tÇng 1", 66, 1596, 3199}, {"§¸y §éng §×nh hå tÇng 2", 67, 1591, 3193},
            {"T­êng V©n ®éng tÇng 1", 116, 1787, 2980}, {"L­u Tiªn ®éng tÇng 1", 125, 1811, 3219},
            {"B¨ng HuyÖt ®éng", 132, 1701, 3407}, {"TuyÕt B¸o ®éng tÇng 3", 147, 1630, 3323},
            {"¸c b¸ ®Þa ®¹o", 163, 1559, 3201}, {"Thiªn TÇm th¸p tÇng 1", 164, 1606, 3194},
            {"Thiªn TÇm th¸p tÇng 2", 165, 1501, 3295}, {"S¬n ®éng Ngù Hoa viªn", 178, 1609, 3200},
            {"NghiÖt Long ®éng", 182, 1997, 3067}, {"Ngäc Hoa ®éng", 194, 1599, 3199}},
    [60] = {{"Tróc T¬ ®éng tÇng 1", 26, 1603, 3210}, {"Th¸nh ®éng tÇng 1", 51, 1666, 3291},
            {"Th¸nh ®éng tÇng 2", 52, 1617, 3261}, {"Hoµnh S¬n Ph¸i", 56, 1594, 3210},
            {"Thanh Loa ®¶o", 68, 1545, 2972}, {"MËt ®¹o Nha m«n T­¬ng D­¬ng", 79, 1599, 3206},
            {"108 La H¸n trËn", 114, 1499, 3312}, {"T­êng V©n ®éng tÇng 2", 117, 1660, 2947},
            {"T­êng V©n ®éng tÇng 3", 118, 1525, 2962}, {"T­êng V©n ®éng tÇng 4", 119, 1569, 3099},
            {"L­u Tiªn ®éng tÇng 2", 126, 1496, 2929}, {"L­u Tiªn ®éng tÇng 3", 127, 1769, 3216},
            {"L­u Tiªn ®éng tÇng 4", 128, 1515, 3123}, {"TuyÕt B¸o ®éng tÇng 4", 148, 1527, 3273},
            {"Mª cung cÊm ®Þa", 158, 1584, 3191}, {"Thiªn TÇm th¸p tÇng 3", 166, 1662, 3245},
            {"D­¬ng Gi¸c ®éng", 196, 1691, 3068}},
    [70] = {{"Tr­êng Giang Nguyªn §Çu", 9, 2478, 5691}, {"Tróc T¬ ®éng tÇng 2", 27, 1607, 3208},
            {"§µo Hoa Nguyªn", 55, 1729, 3282}, {"Thanh Loa ®¶o s¬n ®éng", 69, 1600, 3207},
            {"§¹i Tï ®éng", 72, 1611, 2969}, {"S¬n B¶o ®éng", 76, 1796, 2959},
            {"Linh Cèc ®éng", 94, 1751, 3107}, {"T­êng V©n ®éng tÇng 5", 120, 1815, 3195},
            {"L·o Hæ ®éng", 123, 1698, 3363}, {"L­u Tiªn ®éng tÇng 5", 129, 1597, 3212},
            {"L­u Tiªn ®éng tÇng 6", 130, 1547, 3143}, {"D­îc V­¬ng ®éng tÇng 2", 142, 1467, 3288},
            {"TuyÕt B¸o ®éng tÇng 5", 149, 1611, 3220}, {"Long Nh·n ®éng", 169, 1596, 3212},
            {"TÇn L¨ng tÇng 2", 206, 1790, 3265}, {"L©m Du Quan", 319, 2031, 3286}},
    [80] = {{"Nh¹n Th¹ch ®éng", 10, 1603, 3209}, {"D­îc V­¬ng ®éng tÇng 3", 143, 1602, 3215},
            {"TuyÕt B¸o ®éng tÇng 6", 150, 1613, 3184}, {"TuyÕt B¸o ®éng tÇng 7", 151, 1612, 3218},
            ...
            {"Sa m¹c ®Þa biÓu", 224, 1591, 3013}, {"Ch©n nói Tr­êng B¹ch", 320, 1386, 2253}},
    [90] = {{"M¹c Cao QuËt", 340, 1853, 3446}, {"Tr­êng B¹ch s¬n Nam", 321, 966, 2296},
            {"Tr­êng B¹ch s¬n B¾c", 322, 2048, 4120}, {"Kho¶ Lang ®éng", 75, 1872, 3071},
            {"TiÕn Cóc ®éng", 93, 1526, 3172}, {"C¸n Viªn ®éng", 124, 1672, 3420},
            {"D­îc V­¬ng ®éng tÇng 4", 144, 1690, 3023}, {"TuyÕt B¸o ®éng tÇng 8", 152, 1675, 3365},
            {"Sa M¹c 1", 225, 1476, 3274}, {"Sa M¹c 2", 226, 1553, 3173}, {"Sa M¹c 3", 227, 1530, 3270},
            {"M¹c B¾c Th¶o Nguyªn", 341, 1576, 3040}, {"Vi s¬n ®¶o", 342, 1400, 2800},
            {"H¾c Sa ®éng", 875, 1576, 3177}},
    [100] = {{"TÝch HuyÕt Cèc", 917, 1816, 3392}, {"¸c Nh©n Cèc", 918, 1816, 3392},
             {"Thùc Cèt Nhai", 919, 1608, 3168}, {"H¾c Méc Nhai", 920, 1608, 3168}},
    [110] = {{"Thiªn Phô S¬n", 921, 1560, 3104}, {"Bµn Long S¬n", 922, 1560, 3104},
...
function goto_luyencong()
    ...
    for i = 110, 10, -10 do
        tinsert(tab_Content, "B¶n ®å cÊp " .. i .. "/#goto_luyencong2(" .. i .. ",getn(tbMapTrain[" .. i .. "]))")
    end
...
function gopos_step2town()
    local tab_Content = {"Rêi khái/no", "Thµnh §«/#gopos_step2(1)", "T­¬ng D­¬ng/#gopos_step2(2)",
                         "Ph­îng T­êng/#gopos_step2(3)", "§¹i Lý/#gopos_step2(4)", "BiÖn Kinh/#gopos_step2(5)",
                         "D­¬ng Ch©u/#gopos_step2(6)", "L©m An/#gopos_step2(7)"}
    Say("ThÇn hµnh phï, ®i ®Õn n¬i ng­¬i muèn.", getn(tab_Content), tab_Content);
end
...
function gopos_sevencityfield()
    Say("Ng­¬i muèn ®i chiÕn tr­êng nµo cña ThÊt Thµnh §¹i ChiÕn?", 8,
        "ChiÕn tr­êng Thµnh §«/#goto_sevencityfield(1)", "ChiÕn tr­êng BiÖn Kinh/#goto_sevencityfield(2)",
        "ChiÕn tr­êng §¹i Lý/#goto_sevencityfield(3)", "ChiÕn tr­êng Ph­îng T­êng/#goto_sevencityfield(4)",
        "ChiÕn tr­êng L©m An/#goto_sevencityfield(5)", "ChiÕn tr­êng T­¬ng D­¬ng/#goto_sevencityfield(6)",
...
function gotobosssatthu()
    local tab_Content = {"Boss S¸t thñ 9x/#gopos_9x()", "Boss S¸t thñ 2x/#gopos_2x()",
    ...
    Say("<color=green>H·y chän kÎ mµ ng­¬i muèn tiªu diÖt, ta sÏ ®­a ng­¬i ®Õn chæ h¾n!<color>",
        getn(tab_Content), tab_Content);
end

tab_lv2xmap = {{73, 1544, 2944, "Tr¸c L·nh CÇm", "Phôc L­u §éng"},
...
tab_lv3xmap = {{4, 1576, 2992, "§µo §o¹t Thu", "Kim Quang ®éng"},
               ...
               {193, 1248, 2960, "¢u chÝ Phong", "Vò Di s¬n"}, {193, 912, 2656, "§éc C« HiÖp ", "Vò Di s¬n"},
               {193, 960, 2704, "H¹ng Phï Nhai", "Vò Di s¬n"}, {193, 1440, 3168, "Nghª §¹i Chu", "Vò Di s¬n"}}
tab_lv4xmap = {{5, 1616, 3472, "Du Th¸n Giang ", "Kinh Hoµng ®éng"},
...
tab_lv5xmap = {{12, 1792, 3168, "M¹nh §¹p Hång", "MËt ®¹o TÝn T­íng tù"},
...
tab_lv6xmap = {{164, 1784, 3120, "U«ng ThÖ Thñy", "TÇng 1 Thiªn TÇm th¸p"},
...
tab_lv7xmap = {{123, 1600, 3200, "H¹ng LÖnh Ti", "L·o Hæ ®éng"},
...
tab_lv8xmap = {{201, 1768, 3200, "DiÖp øc Anh", "B¨ng Hµ ®éng"},
...
tab_lv9xmap = {{93, 1640, 3264, "Gi¶ Giíi Nh©n", "TiÕn Cóc ®éng"},
...
{321, 1288, 2608, "Bµo TriÖt s¬n ", "Tr­êng B¹ch nam"}, {321, 1112, 2560, "V¹n Hå Tinh", "Tr­êng B¹ch nam"},
...
function gopos_2xdi(nIdx)
    ...
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv2xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv2xmap[nIdx][4] .. "<color> nµo!");
end
-- Boss Sat Thu 3x
...
function gopos_3xdi(nIdx)
    ...
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv3xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv3xmap[nIdx][4] .. "<color> nµo!");
end
-- Boss Sat thu 4x
...
function gopos_4xdi(nIdx)
    ...
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv4xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv4xmap[nIdx][4] .. "<color> nµo!");
end
-- Boss Sat Thu 5x
...
function gopos_5xdi(nIdx)
    ...
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv5xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv5xmap[nIdx][4] .. "<color> nµo!");
end
-- Boss Sat Thu 6x
...
function gopos_6xdi(nIdx)
    ...
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv6xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv6xmap[nIdx][4] .. "<color> nµo!");
end
-- Boss Sat Thu 7x
...
function gopos_7xdi(nIdx)
    ...
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv7xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv7xmap[nIdx][4] .. "<color> nµo!");
end
-- Boss Sat Thu 8x
...
function gopos_8xdi(nIdx)
    ...
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv8xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv8xmap[nIdx][4] .. "<color> nµo!");
end
-- Boss Sat Thu 9x
...
function gopos_9xdi(nIdx)
    ...
    Msg2Player("H·y ngåi yªn, chóng ta ®i ®Õn <color=Green>" .. tab_lv9xmap[nIdx][5] ..
                   "<color> ®Ó tiªu diÖt <color=Yellow>" .. tab_lv9xmap[nIdx][4] .. "<color> nµo!");
end
