...
SKILLS = {
    ...
    docamhoacot = { -- Ngu Doc
        ...
        poisondamage_v = {{{1, 200}, {15, 350}, {20, 600}}, {{1, 60}, {10, 60}, {15, 60}, {20, 60}, {30, 60}},
                          {{1, 10}, {20, 10}}},
        skill_cost_v = {{{1, 50}, {20, 50}}},
        skill_eventskilllevel = {{{1, 1}, {20, 20}}},
        skill_startevent = {
    ...
    tanthu = { -- buff tan thu
        lifemax_yan_p = {{{1, 100}, {30, 300}}, {{1, -1}, {30, -1}}}, -- Sinh lùc tèi ®a (%) (D­¬ng)
        lifereplenish_v = {{{1, 100}, {30, 3000}}, {{1, -1}, {30, -1}}}, -- Phôc håi sinh lùc mçi nöa gi©y
        manareplenish_v = {{{1, 100}, {30, 3000}}, {{1, -1}, {30, -1}}}, -- Phôc håi néi lùc mçi nöa gi©y
        fastwalkrun_p = {{{1, 50}, {30, 100}, {31, 200}}, {{1, -1}, {30, -1}}}, -- Tèc ®é di chuyÓn
        deadlystrikeenhance_p = {{{1, 100}, {30, 1000}}, {{1, -1}, {30, -1}}}, -- S¸t th­¬ng chÝ m¹ng
        skill_enhance = {{{1, 1000}, {30, 3000}}, {{1, -1}, {30, -1}}}, -- T¨ng c«ng kÝch kü n¨ng		
        ignoredefense_p = {{{1, 90}, {20, 99}, {21, 99}}, {{1, -1}, {30, -1}}}, -- Bá qua nÐ tr¸nh
        deadlystrike_p = {{{1, 50}, {20, 100}}, {{1, -1}, {30, -1}}}, -- TØ lÖ tÊn c«ng chÝ m¹ng: #d1-%
        fatallystrike_p = {{{1, 50}, {20, 100}}, {{1, -1}, {30, -1}}}, -- TØ lÖ tÊn c«ng chÝ tö #d1-%
        attackspeed_v = {{{1, 50}, {30, 150}}, {{1, -1}, {30, -1}}}, -- Tèc ®é ®¸nh ngo¹i c«ng
        castspeed_v = {{{1, 50}, {30, 150}}, {{1, -1}, {30, -1}}}, -- Tèc ®é ®¸nh  néi c«ng
        lucky_v = {{{1, 100}, {30, 1000}}, {{1, -1}, {30, -1}}}, -- May m¾n
        sorbdamage_p = {{{1, 10}, {30, 300}}, {{1, -1}, {30, -1}}}, -- TriÖt tiªu s¸t th­¬ng
        block_rate = {{{1, 10}, {30, 30}}, {{1, -1}, {30, -1}}} -- X¸c suÊt hãa gi¶i s¸t th­¬ng		
    },
    badao = { -- Max buff
        expenhance_p = {{{1, 10000}, {30, 300000}}, {{1, -1}, {30, -1}}}, -- S¸t th­¬ng ®Þch nhËn ®­îc kinh nghiÖm
        ...
        allres_p = {{{1, 10000}, {30, 300000}}, {{1, -1}, {30, -1}}}, -- Kh¸ng tÊt c¶
        attackspeed_v = {{{1, 10}, {30, 300}}, {{1, -1}, {30, -1}}}, -- Tèc ®é ®¸nh ngo¹i c«ng
        castspeed_v = {{{1, 10}, {30, 300}}, {{1, -1}, {30, -1}}}, -- Tèc ®é ®¸nh néi c«ng
        lucky_v = {{{1, 10}, {30, 300}}, {{1, -1}, {30, -1}}}, -- May m¾n
        ...
        ignoredefense_p = {{{1, 100}, {30, 100}}, {{1, -1}, {30, -1}}}, -- Bá qua nÐ tr¸nh
        strength_v = {{{1, 10000}, {30, 300000}}, {{1, -1}, {30, -1}}}, -- Søc m¹nh
        dexterity_v = {{{1, 10000}, {30, 300000}}, {{1, -1}, {30, -1}}}, -- Th©n ph¸p
        vitality_v = {{{1, 10000}, {30, 300000}}, {{1, -1}, {30, -1}}}, -- Sinh khÝ
        energy_v = {{{1, 10000}, {30, 300000}}, {{1, -1}, {30, -1}}}, -- Néi c«ng
        add_boss_damage = {{{1, 10000}, {30, 300000}}, {{1, -1}, {30, -1}}}, -- S¸t th­¬ng g©y ra cho boss
        do_hurt_p = {{{1, 10000}, {30, 300000}}, {{1, -1}, {30, -1}}}, -- Ngò hµnh t­¬ng kh¾c
        skill_enhance = {{{1, 10000}, {30, 300000}}, {{1, -1}, {30, -1}}}, -- T¨ng c«ng kÝch kü n¨ng
        deadlystrike_p = {{{1, 100}, {30, 100}}, {{1, -1}, {30, -1}}}, -- TØ lÖ tÊn c«ng chÝ m¹ng: #d1-%
        deadlystrikeenhance_p = {{{1, 100}, {30, 1000}}, {{1, -1}, {30, -1}}}, -- S¸t th­¬ng chÝ m¹ng
        fatallystrike_p = {{{1, 100}, {30, 100}}, {{1, -1}, {30, -1}}} -- TØ lÖ tÊn c«ng chÝ tö #d1-%
    }
}
