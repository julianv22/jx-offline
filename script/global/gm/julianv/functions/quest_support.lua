...
function main()
    ...
    local tb = {"NhiÖm vô Th«n trÊn/nvthontran", "NhiÖm vô M«n ph¸i/nvmonphai",
...
tb_HelpThonTran = {
    ...
    [3] = { -- VÜnh L¹c TrÊn
        [1] = {
            ...
            [6] = {"Mang quyÓn s¸ch “Kª ThÇn Lôc“ cña C¸t Gia vÒ cho Lç Gia. Hoµn thµnh nhiÖm vô.", 0, 1,
                   99, 1689, 3201}
        },
        [2] = {
    ...
    [4] = { -- Chu Tiªn TrÊn
        [1] = {
            ...
            [3] = {"§Õn Töu ®iÕm, gÆp l·o Chu khuyªn l·o vÒ nhµ. Hoµn thµnh nhiÖm vô.", 0, 1, 100, 1680,
                   3232}
        },
        [2] = {
            ...
            [4] = {"Quay l¹i gÆp Doanh Doanh, th«ng b¸o l¹i víi c« Êy. Hoµn thµnh nhiÖm vô.", 0, 1, 100,
                   1736, 3152}
        },
        [3] = {
...
function nvthontran()
    ...
    local tb = {"Ba L¨ng HuyÖn/#villagequest(1)", "Giang T©n Th«n/#villagequest(2)",
...
function villagequest(IDv)
    ...
    local tb = {"NhiÖm vô 1/#villagequest_step1(" .. MissType .. ",1)",
...
tb_HelpMonPhai = {
    [0] = { -- Thieu lam
        ...
        [2] = {
            ...
            [6] = {"§¸nh b¹i Man Di thø t­ ë Phôc Ng­u S¬n T©y (Ngay gÇn con thø 3)", "", 1, 1, 41, 2094,
                   2926},
        ...
        [8] = {
            ...
            [8] = {"Trë l¹i t×m Th­êng B¸ch Lý vµ Lý DÞch Phong b¸o tin tiªu diÖt Kim Quèc t­íng lÜnh.",
                   "", 0, 0, 2, 326, 224},
    ...
    [2] = { -- Duong Mon
        ...
        [4] = {
            ...
            [18] = {"Trë l¹i §­êng M«n ®Õn phßng Y D­îc, gÆp §­êng D·, hoµn thµnh nhiÖm vô", "", 0,
                    1, 32, 1603, 3210}
        },
        [5] = {
    ...
    [3] = { -- Ngu doc
        ...
        [6] = {
            ...
            [3] = {"§¸nh Nh¹n ®¨ng ph¸i ®Ö tö (§Õn khi Ch­ëng m«n xuÊt hiÖn, ®¸nh b¹i Ch­ëng m«n lÊy Tõ §éc Chu)",
                   "", 1, 1, 196, 1648, 2944},
    ...
    [4] = { -- Nga Mi
        ...
        [2] = {
            ...
            [2] = {"GÆp DiÖu Nh­",
                   "§Õn Gi¶ng Kinh ®­êng gÆp DiÖu Nh­, tiÕp nhËn nhiÖm vô thu phôc M·nh hæ", 0, 1, 15,
                   1586, 3199},
            [3] = {"§Õn M·nh Hæ huyÖt ®éng",
                   "§Õn M·nh Hæ huyÖt ®éng phÝa sau nói, trong ®ã cã ba con B¹ch Hæ, ph¶i ®¸nh ba con nµy liªn tôc ba lÇn, sÏ khuÊt phôc ®­îc chóng.",
                   1, 1, 14, 1784, 3197},
            [4] = {"GÆp DiÖu Nh­",
                   "Trë vÒ Gi¶ng Kinh ®­êng gÆp DiÖu Nh­ phôc mÖnh, hoµn thµnh nhiÖm vô", 0, 1, 15, 1586,
                   3199}
        },
        [3] = {
    ...
    [5] = { -- Thuy yen
        [1] = {
            ...
            [4] = {"Trë vÒ giao Thóy Vò Tr©m cho Do·n Hµm Yªn, hoµn thµnh nhiÖm vô", "", 0, 1, 161, 1591,
                   3203}
        },
        [2] = {
        ...
        [3] = {
            ...
            [4] = {"Vµo Thæ PhØ S¬n §éng giÕt Thæ PhØ cøu con g¸i §oµn L·o Ho¸n", "", 1, 1, 170, 1858,
                   3094},
            [5] = {"Trë l¹i gÆp §oµn L·o Ho¸n", "", 0, 1, 162, 1512, 3277},
            [6] = {"§Õn bÕn tµu mua Ng©n TuyÕt Ng­ cña ThuyÒn Gia", "", 1, 1, 162, 1640, 2935},
            [7] = {"§Õn suèi Hå §iÖp thµnh §¹i Lý b¾t BÝch Th­êng Phông §iÖp", "", 0, 1, 162, 1472,
                   3145},
    ...
    [6] = { -- Cai bang OK
        ...
        [4] = {
            ...
            [3] = {"§¸nh b¹i Kim Quèc ThÝch Kh¸ch 1 (lÊy ThÝch s¸t mËt hµm - tû lÖ thÊp)", "", 1, 0, 180,
                   226, 183},
            [4] = {"§¸nh b¹i Kim Quèc ThÝch Kh¸ch 2 (lÊy ThÝch s¸t mËt hµm - tû lÖ thÊp)", "", 1, 0, 180,
                   178, 195},
        ...
        [5] = {
            ...
            [6] = {"Sau khi ®­a ®Þa ®å cho Tµo C«ng C«ng, trë vÒ gÆp Tr­¬ng TuÊn", "", 0, 1, 176, 1482,
                   3416},
        ...
        [6] = {
            ...
            [10] = {"T4 më r­¬ng (lÊy tói råi quay l¹i ®¸nh H¹c Hµnh lÊy ch×a khãa 2). Max 2 tói", "", 1,
                    1, 119, 1504, 3327},
    ...
    [7] = { -- Thien nhan
        ...
        [6] = {
            ...
            [12] = {"Mang 5 thanh kiÕm vÒ cho Hoµn Nhan Hång LiÖt (sau ®ã tù ch¹y tíi cöa th¸nh ®éng ngay sau)",
                    "", 0, 1, 49, 1721, 3129},
    ...
    [8] = { -- Vo dang
        ...
        [2] = {
            ...
            [3] = {"§¸nh Sãi §á 1 (LÊy Thiªn T»m Bµo r¸ch)",
                   "§Õn khi nhËn ®­îc Thiªn T»m §¹o Bµo r¸ch", 1, 1, 83, 1510, 3050},
            [4] = {"§¸nh Sãi §á 2 (LÊy Thiªn T»m Bµo r¸ch)",
            ...
            [7] = {"§¸nh D· H¸n 1 (Cøu ®øa bÐ, lÊy thiªn t»m)",
                   "§Õn khi cøu ®­îc ®øa bÐ lÊy ®­îc Thiªn T»m", 1, 1, 83, 1582, 2860},
            [8] = {"§¸nh D· H¸n 2 (Cøu ®øa bÐ, lÊy thiªn t»m)",
    ...
    [9] = { -- Con lon
        ...
        [4] = {
            ...
            [6] = {"Giao HuyÕt Hån ThÇn KiÕm cho Thanh Liªn Tö, hoµn thµnh nhiÖm vô", "", 0, 1, 139, 1606,
                   3199}
        },
        [5] = {
        ...
        [6] = {
            ...
            [13] = {"TiÕn ®Õn tÇng 6, chän Hai bøc t­îng sóc vËt b»ng gç ®Ó lªn tÇng 6", "", 1, 1, 129,
                    1645, 3250},
...
function help_quest()
    ...
    local tab_Content = {"NhiÖm vô cÊp 10 " .. TenMP .. "/#help_quest_step1(" .. nFaction .. ",1,2," ..
...
function help_quest_step1(nFaction, nIDQ, nX, nY)
    ...
    for i = nX1, nY1 do
        ...
        tinsert(tbOpt, {tb_HelpMonPhai[nFaction][nIDQ][i][1], help_quest_step2,
                        {FightState, TypeMove, MapId, nX, nY, TenMP, TenNV, tb_HelpMonPhai[nFaction][nIDQ][i][2],
                         tb_HelpMonPhai[nFaction][nIDQ][i][1]}})
    end
    if (nX1 ~= 2) then
...
function help_quest_step2(FightState, TypeMove, MapId, nX, nY, MonPhai, NhiemVu, BuocThucHien, NoiDungNhiemVu)
    ...
    SetFightState(FightState)
    Msg2Player("§ang thùc hiÖn <color=yellow>" .. NhiemVu .. "<color> m«n ph¸i <color=yellow>" .. MonPhai ..
                   "<color>. Néi dung nhiÖm vô: <color=green>" .. NoiDungNhiemVu .. "<color>")
...
function gquest(ID)
    ...
    local tb = {"ChÝnh ph¸i - BÝ mËt TÇm Long Héi/#gquest_step1(" .. MissType .. ",1)",
...
function gquest_step1(ID1, ID2)
    ...
    if MissType == 1 then -- chÝnh tuyÕn
        local tab_Content = {"ChÝnh tuyÕn cÊp 20/#gquest_step2(" .. MissType .. "," .. PheType .. ",1)",
        ...
        Say("Hç trî lµm nhiÖm vô hoµng kim <color=yellow>ChÝnh TuyÕn<color>", getn(tab_Content), tab_Content);
    elseif MissType == 2 then -- phô tuyÕn
        local tab_Content = {"Phô tuyÕn cÊp 20 - 29/#gquest_step2(" .. MissType .. "," .. PheType .. ",1)",
                             ...
                             "Quay l¹i/main", "KÕt thóc ®èi tho¹i/Quit"}
        Say("Hç trî lµm nhiÖm vô hoµng kim <color=yellow>Phô TuyÕn<color>", getn(tab_Content), tab_Content);
    end
end
