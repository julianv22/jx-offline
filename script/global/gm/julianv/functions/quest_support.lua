...
function main()
    ...
    local tb = {
        "NhiÖm vô Th«n trÊn/nvthontran", "NhiÖm vô M«n ph¸i/nvmonphai",
        "NhiÖm vô Hoµng kim/nvhoangkim", "Tho¸t./Quit",
    }
    Say(Talk, getn(tb), tb)
    return 1
end
...
tb_HelpThonTran = {
    [1] = { -- Ba L¨ng HuyÖn 
        ...
        [3] = {
            [1] = {
                "NhiÖm vô thø 3: <color=green>Con trai cña Cæ L·o Th¸i<color> <enter>PhÇn th­ëng cho b¹n: B¹n l¹i cã thªm <color=yellow>tiÒn<color> vµ <color=red>®iÓm danh väng<color> ®Ó ®i du ngo¹n giang hå råi!<enter> - §Õn gÆp <color=red>Cæ L·o Th¸i (204/202).<color> - ¤ng ta cho b¹n biÕt con trai cña m×nh ®i ®¸nh c¸ suèt ba ngµy nay kh«ng thÊy vÒ! Nhê b¹n ®i t×m gióp nã vÒ.<enter> - B¹n h·y ®i vÒ <color=red>h­íng §«ng B¾c<color>, ®Õn <color=red>§éng §×nh hå.<color> - B¹n kh«ng t×m thÊy con trai cña <color=red>Cæ gia<color> nh­ng l¹i nh×n thÊy mét <color=green>miÕng Ngäc Béi<color> <color=red>(225/188).<color><enter> - Mang miÕng <color=green>Ngäc Béi<color> vÒ cho <color=red>Cæ L·o Th¸i.<color> - ¤ng ta v« cïng ®au xãt. Sau mét håi khãc th­¬ng, «ng ta tÆng cho b¹n mét bøc tranh gäi lµ t¹ ¬n gióp ®ì. Hoµn thµnh nhiÖm vô vµ nhËn ®­îc <color=red>®iÓm danh väng.<color><enter> - B¹n cã nhí lµ lóc ®i ®Õn <color=red>§éng §×nh hå<color> ®· gÆp qua mét <color=red>Du kh¸ch (224/192)<color> kh«ng? <enter> - H·y trë l¹i ®ã ®Ó gÆp «ng Êy. Sau håi l©u ®èi tho¹i «ng ta sÏ mua bøc tranh nµy víi gi¸ <color=yellow>1000 l­îng<color> hoÆc h¬n. <enter> - ",
            },
    ...
    [5] = { -- §¹o H­¬ng Th«n 
        ...
        [3] = {
            ...
            [7] = { "Mang thuèc vÒ cho TiÓu Lan. Hoµn thµnh nhiÖm vô.", 0, 1, 101, 1648,
                    3312 },
        },
    },
    [6] = { -- Long M«n TrÊn 
    ...
    [7] = { -- Th¹ch Cæ TrÊn 
        [1] = {
            [1] = {
                "NhiÖm vô thø 1: <color=green>§­a c¬m<color><enter>PhÇn th­ëng cho b¹n: Mét mãn <color=green>vò khÝ<color> vµ <color=red>3 ®iÓm<color> danh väng.<enter> - T×m gÆp <color=red>LiÔu DiÖp Nhi (207/201)<color>, nhËn nhiÖm vô ®i ®­a c¬m.<enter> - §i t×m <color=red>Vâ s­ (207/203)<color>. §­a c¬m cho «ng Êy. Hoµn thµnh nhiÖm vô.",
            },
    ...
    [8] = { -- Long TuyÒn Th«n
        ...
        [3] = {
            ...
            [5] = {
                "Mang d­îc liÖu vÒ cho Chung Ly. Hoµn thµnh nhiÖm vô.", 0, 1, 174, 1640,
                3216,
            },
        },
    },
...
function nvthontran()
    local Talk =
        "CÈm nang ®Æc biÖt gióp dÞch chuyÓn nhanh c¸c ®Þa ®iÓm lµm nhiÖm vô Th«n trÊn.\nHoµn thµnh nhiÖm vô, ng­¬i sÏ nhËn ®­îc nh÷ng phÇn th­ëng xøng ®¸ng.\nTruy cËp: <color=green>Youtube: PYTA GAMING<color> ®Ó update."
    local tb = {
        "Ba L¨ng HuyÖn/#villagequest(1)", "Giang T©n Th«n/#villagequest(2)",
        "VÜnh L¹c TrÊn/#villagequest(3)", "Chu Tiªn TrÊn/#villagequest(4)",
        "§¹o H­¬ng Th«n/#villagequest(5)", "Long M«n TrÊn/#villagequest(6)",
        "Th¹ch Cæ TrÊn/#villagequest(7)", "Long TuyÒn Th«n/#villagequest(8)", "Quay l¹i/main",
        "Tho¸t./Quit",
    }
    Say(Talk, getn(tb), tb)
    return 1
...
function villagequest( IDv )
    ...
    local tb = {
        ...
        "NhiÖm vô 3/#villagequest_step1(" .. MissType .. ",3)", "Quay l¹i/nvthontran",
        "KÕt thóc ®èi tho¹i/Quit",
    }
    Say(
        "Mçi th«n lµng ®Òu cã Ýt nhÊt 3 nhiÖm vô, nÕu th«n nµo hay trÊn nµo kh«ng cã nhiÖm vô thø 3 th× sÏ kh«ng hiÓn thÞ.",
        getn(tb), tb)
end
...
function villagequest_step1( ID1, ID2 )
    ...
    for i = 2, TotalSelect do
        ...
        tinsert(tbOpt, {
            tb_HelpThonTran[MissType][PheType][i][1], villagequest_step3,
            { FightState, MapId, nX, nY },
        })
...
tb_HelpMonPhai = {
    [0] = { -- Thieu lam
        [1] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 10 ThiÕu L©m Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>ThiÕu L©m C«n Ph¸p<enter>ThiÕu L©m QuyÒn Ph¸p<enter>ThiÕu L©m §ao Ph¸p<color>",
            },
            ...
            [4] = {
                "Quay l¹i Tõ Nh©n Ph­¬ng Tr­îng hoµn thµnh nhiÖm vô", "", 0, 1, 109,
                1598, 3178,
            },
        },
        [2] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 20 ThiÕu L©m Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>BÊt §éng Minh V­¬ng<color>",
            },
            ...
            [3] = {
                "§¸nh b¹i Man Di thø nhÊt ë Phôc Ng­u S¬n T©y", "", 1, 1, 41, 2235, 2970,
            },
            [4] = { "§¸nh b¹i Man Di thø hai ë Phôc Ng­u S¬n T©y", "", 1, 1, 41, 2160,
                    2943 },
            [5] = { "§¸nh b¹i Man Di thø ba ë Phôc Ng­u S¬n T©y", "", 1, 0, 41, 264, 185 },
            [6] = {
                "§¸nh b¹i Man Di thø t­ ë Phôc Ng­u S¬n T©y (Ngay gÇn con thø 3)", "",
                1, 1, 41, 2094, 2926,
            },
            [7] = {
                "§¸nh b¹i Man Di thø n¨m ë Phôc Ng­u S¬n T©y", "", 1, 1, 41, 2210, 3010,
            },
            [8] = {
                "Trë vÒ phông mÖnh HuyÒn Bi, hoµn thµnh nhiÖm vô", "", 0, 1, 105, 1599,
                3191,
            },
        },
        [3] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 30 ThiÕu L©m Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>La H¸n TrËn<color>",
            },
        ...
        [4] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 40 ThiÕu L©m Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>S­ Tö Hèng<color>",
            },
            ...
            [9] = {
                "Trë l¹i gÆp Tõ Nh©n Ph­¬ng Tr­îng, hoµn thµnh nhiÖm vô", "", 0, 1,
                109, 1598, 3178,
            },
        },
        [5] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 50 ThiÕu L©m Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Hoµnh T¶o Lôc Hîp<enter>Ma Ha V« L­îng<enter>Long Hæ Tr¶o<color>",
            },
            ...
            [7] = {
                "Mang DÞch C©n Kinh cho HuyÒn Tõ, hoµn thµnh nhiÖm vô", "", 0, 1, 104, 1594,
                3183,
            },
        },
        [6] = {
            ...
            [4] = {
                "Mang 4 b¶o vËt vÒ cho HuyÒn Nan, hoµn thµnh nhiÖm vô", 0, 0, 103, 202, 192,
            },
        },
        [7] = {
            [1] = {
                "<color=green>NhiÖm vô Trïng Ph¶n S­ M«n ThiÕu L©m Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Nh­ Lai Thiªn DiÖp<enter>DÞch C©n Kinh<color>",
            },
        ...
        [8] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 90 ThiÕu L©m Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>§¹t Ma §é Giang<enter>Hoµnh T¶o Thiªn Qu©n<enter>V« T­íng Tr¶m<color>",
            },
            ...
            [2] = {
                "Lªn Hoa S¬n C¶nh Kü Tr­êng gÆp Th­êng B¸ch Lý vµ Lý DÞch Phong", "",
                0, 0, 2, 326, 224,
            },
            ...
            [6] = {
                "Trë l¹i t×m Th­êng B¸ch Lý vµ Lý DÞch Phong ®­a lÖnh bµi.", "", 0, 0,
                2, 326, 224,
            },
            [7] = { "Tiªu diÖt Kim Quèc t­íng lÜnh", "", 1, 0, 2, 323, 240 },
            [8] = {
                "Trë l¹i t×m Th­êng B¸ch Lý vµ Lý DÞch Phong b¸o tin tiªu diÖt Kim Quèc t­íng lÜnh.",
                "", 0, 0, 2, 326, 224,
            },
        ...
        [9] = {
            [1] = {
                "<color=green>BÝ kÝp kü n¨ng cÊp 120 cã thÓ thu thËp t¹i Kú Tr©n C¸c<color>",
            },
        ...
        [10] = {
            ...
            [3] = {
                "§Õn BiÖn Kinh t×m TÇn Khëi TËt lÊy Qu¶ng H¾c H­¬ng", "", 0, 0, 37, 220,
                187,
            },
    ...
    [1] = { -- Thien vuong 
        [1] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 10 Thiªn V­¬ng Bang<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Thiªn V­¬ng Th­¬ng Ph¸p<enter>Thiªn V­¬ng §ao ph¸p<enter>Thiªn V­¬ng Chïy ph¸p<color>",
            },
        ...
        [2] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 20 Thiªn V­¬ng Bang<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>TÜnh T©m QuyÕt<color>",
            },
        ...
        [3] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 30 Thiªn V­¬ng Bang<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>B¸t Phong Tr¶m<enter>D­¬ng Quan Tam DiÖp<enter>Hµng V©n QuyÕt<color>",
            },
        ...
        [4] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 40 Thiªn V­¬ng Bang<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>§o¹n Hån ThÝch<color>",
            },
        ...
        [5] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 50 Thiªn V­¬ng Bang<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Kim Chung Tr¸o<color>",
            },
        ...
        [7] = {
            [1] = {
                "<color=green>NhiÖm vô Trïng Ph¶n S­ M«n Thiªn V­¬ng Bang<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Thiªn V­¬ng ChiÕn ý<enter>V« T©m Tr¶m, HuyÕt ChiÕn B¸t Ph­¬ng<enter>Thõa Long QuyÕt<color>",
            },
            [2] = { "§èi tho¹i Bang Chñ, nép 5 v¹n l­îng", "", 0, 1, 62, 1609, 3199 },
        },
        [8] = { ---------------------------------------------------
            [1] = {
                "<color=green>NhiÖm vô cÊp 90 Thiªn V­¬ng Bang<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Ph¸ Thiªn Tr¶m<enter>Truy Tinh Trôc NguyÖt<enter>Truy Phong QuyÕt<color>",
            },
    ...
    [2] = { -- Duong Mon
        [1] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 10 §­êng M«n<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>§­êng M«n ¸m khÝ<enter>§Þa DiÖm Háa<color>",
            },
            ...
            [6] = {
                "Mang nhÉn M· N·o ®æi Ma Vò Ch©m cña T«n UyÓn", "", 0, 1, 11, 3155, 5184,
            },
            [7] = {
                "Giao Ma Vò Ch©m cho §­êng H¹c, hoµn thµnh nhiÖm vô", "", 0, 1, 31, 1607,
                3204,
            },
        },
        [2] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 20 §­êng M«n<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>§éc ThÝch Cèt<color>",
            },
            ...
            [8] = {
                "§¸nh XÝch DiÖm Ng¹c [C¸ SÊu §á] lÊy Kim H¹ng QuyÒn", "", 1, 1, 25,
                3716, 5050,
            },
            [9] = { "Trë l¹i gÆp §­êng U nãi chuyÖn", "", 1, 1, 25, 4227, 4667 },
            [10] = {
                "Giao Kim H¹ng QuyÒn cho §­êng Cõu, hoµn thµnh nhiÖm vô", "", 0, 1, 33,
                1617, 3191,
            },
        },
        [3] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 30 §­êng M«n<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Truy T©m TiÔn<enter>M¹n Thiªn Hoa Vò <enter>§o¹t Hån Tiªu<enter>Xuyªn T©m Thø<color>",
            },
            ...
            [3] = {
                "§¸nh §¹i §Çu Môc Cuång Sa - B¹ch V©n §éng", "", 1, 1, 22, 1831, 3200,
            },
            ...
            [9] = {
                "Mang háa KhÝ Phæ cho §­êng V©n, hoµn thµnh nhiÖm vô", "", 0, 1, 30,
                1599, 3203,
            },
        },
        [4] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 40 §­êng M«n<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Hµn B¨ng ThÝch<color>",
            },
            ...
            [10] = {
                "Trë l¹i §­êng M«n ®Õn phßng Y D­îc, gÆp §­êng D·", "", 0, 1, 32,
                1603, 3210,
            },
            ...
            [18] = {
                "Trë l¹i §­êng M«n ®Õn phßng Y D­îc, gÆp §­êng D·, hoµn thµnh nhiÖm vô",
                "", 0, 1, 32, 1603, 3210,
            },
        },
        [5] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 50 §­êng M«n<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>L«i KÝch thuËt<color>",
            },
            ...
            [8] = {
                "Giao ¸m KhÝ phæ cho §­êng Nhµn, hoµn thµnh nhiÖm vô", "", 0, 1, 29,
                1599, 3203,
            },
        },
        [6] = {
            ...
            [7] = {
                "GÆp Ch­ëng m«n §­êng Cõu, hoµn thµnh nhiÖm vô", "", 0, 1, 33, 1617,
                3191,
            },
        },
        [7] = {
            [1] = {
                "<color=green>NhiÖm vô Trïng Ph¶n S­ M«n §­êng M«n<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>TiÓu Lý Phi §ao<enter>T¸n Hoa Tiªu<enter>Thiªn La §Þa Vâng<enter>T©m Nh·n<color>",
            },
        ...
        [8] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 90 §­êng M«n<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>NhiÕp Hån NguyÖt ¶nh<enter>Cöu Cung Phi TÝnh<enter>B¹o Vò Lª Hoa<enter>Lo¹n Hoµn KÝch<color>",
            },
            -- [1] = {"Yªu cÇu: Tõ cÊp 90 trë lªn, danh väng trªn 240 ®iÓm, lµ §­êng M«n ký danh ®Ö tö, tr­íc m¾t ch­a gia nhËp m«n ph¸i nµo.<enter>PhÇn th­ëng:<enter>NhiÕp Hån NguyÖt ¶nh<enter>Cöu Cung Phi TÝnh<enter>B¹o Vò Lª Hoa<enter>Lo¹n Hoµn KÝch<enter>Danh väng ®­îc 30 ®iÓm. (TÊt c¶ c¸c m«n ph¸i kh¸c ®Òu cã thÓ lµm nhiÖm vô nµy ®Ó nhËn phÇn th­ëng ®iÓm danh väng, nh¬ng kh«ng häc ®­îc chiªu thøc)<enter>C¸c b­íc thùc hiÖn nhiÖm vô<enter><color=red>B­íc 1: <color>§Õn Thµnh §« -> th«n Giang T©n, gÆp §­êng Nguyªn (430,385), biÕt ®­îc §­êng BÊt NhiÔm cã nh÷ng dÊu hiÖu bÊt th­êng vµ b¹n quyÕt t©m t×m hiÓu cho cÆn kÏ mäi viÖc.<enter><color=red>B­íc 2: <color>§Õn §­êng M«n t¹i phßng TÕ tæ phßng (513,317), gÆp §­êng BÊt NhiÔm... H¾n nhê b¹n chuyÓn dïm 1 bøc th¬.<enter><color=red>B­íc 3: <color>§Õn BiÖn Kinh gÆp B¹ch C«ng Tö (207,191) giao th¬. H¾n ®äc th¬ mét håi råi giao l¹i cho b¹n 1 bøc th¬ håi ©m.<enter><color=red>B­íc 4: <color>Quay l¹i §­êng M«n giao th¬ cho §­êng BÊt NhiÔm . §¸nh b¹i §­êng BÊt NhiÔm, nhËn quyÓn s¸ch §­êng M«n TuyÖt Häc MËt TÞch. (L­u ý: nÕu Nh­ trong lóc ®¸nh, b¹n cã bÞ tö th­¬ng, b¹n vÉn cã thÓ vµo ®¸nh tiÕp, m¸u cña §­êng BÊt NhiÔm vÉn bÞ mÊt Nh­ thêi ®iÓm b¹n chÕt).<enter><color=red>B­íc 5: <color>§Õn BiÖn Kinh -> Thiªn NhÉn gi¸o -> tÇng 1 -> tÇng 2 -> tÇng 3 gÆp §oan Méc DuÖ (225,199) giao s¸ch. §oan Méc DuÖ l¹i nhê b¹n göi lêi ®Õn §­êng BÊt NhiÔm.<enter><color=red>B­íc 6: <color>Quay l¹i §­êng M«n gÆp §­êng BÊt NhiÔm, hoµn thµnh nhiÖm vô.<enter>L­u ý:<enter>NÕu ®· lªn ®­îc tÇng 2 råi mµ bÞ chÕt th× khi vµo ®éng l¹i cø viÖc lªn tÇng 2, kh«ng cÇn ®¸nh l¹i ë tÇng 1."},
        ...
        [10] = {
            ...
            [6] = {
                "GÆp §­êng M«n Tr¸ng §inh thø t­, hoµn thµnh nhiÖm vô", "", 0, 0, 25,
                479, 339,
            },
        },
    },
    [3] = { -- Ngu doc
        [1] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 10 Ngò §éc Gi¸o<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Ngò §éc §ao ph¸p<enter>Ngò §éc Ch­ëng ph¸p<enter>Cöu Thiªn Cuång L«i<color>",
            },
        ...
        [2] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 20 Ngò §éc Gi¸o<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>XÝch DiÖm Thùc Thiªn<enter>T¹p Nan D­îc Kinh<color>",
            },
        ...
        [3] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 30 Ngò §éc Gi¸o<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>U Minh Kh« L©u<enter>V« H×nh §éc<enter>B¸ch ®éc Xuyªn T©m<enter>B¨ng Lam HuyÒn Tinh<color>",
            },
            ...
            [5] = {
                "§¸nh Ph¶n TÆc §Çu Môc (lÊy Méc H­¬ng §Ønh thËt)", "", 1, 1, 193,
                1170, 2928,
            },
        ...
        [4] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 40 Ngò §éc Gi¸o<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>V¹n §éc Thùc T©m<enter>Xuyªn Y Ph¸ Gi¸p<color>",
            },
        ...
        [5] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 50 Ngò §éc Gi¸o<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Xuyªn T©m §éc Thø<color>",
            },
        ...
        [6] = {
            ...
            [3] = {
                "§¸nh Nh¹n ®¨ng ph¸i ®Ö tö (§Õn khi Ch­ëng m«n xuÊt hiÖn, ®¸nh b¹i Ch­ëng m«n lÊy Tõ §éc Chu)",
                "", 1, 1, 196, 1648, 2944,
            },
            [4] = { "GÆp H¾c DiÖn Lang Qu©n, hoµn thµnh nhiÖm vô", "", 0, 1, 189, 1606,
                    3189 },
        },
        [7] = {
            [1] = {
                "<color=green>NhiÖm vô Trïng Ph¶n S­ M«n Ngò §éc Gi¸o<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Thiªn C­¬ng §Þa S¸t<enter>Chu C¸t Thanh Minh<enter>Ngò §éc Kú Kinh<color>",
            },
            [2] = { "§èi tho¹i Gi¸o chñ, nép 5 v¹n l­îng", "", 0, 1, 189, 1606, 3189 },
        },
        [8] = { ----------------------------------------
            [1] = {
                "<color=green>NhiÖm vô cÊp 90 Ngò §éc Gi¸o<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>¢m Phong Thùc Cèt<enter>HuyÒn ¢m Tr¶m<enter>§o¹n C©n Hñ Cèt<color>",
            },
        ...
        [10] = {
            ...
            [7] = { "GiÕt Th»n L»n", "", 1, 1 },
            [6] = {
                "Giao cho §Ö Tø Ngò §éc Gi¸o ë cöa ®éng, hoµn thµnh nhiÖm vô", "", 0,
                1,
            },
        },
    },
    [4] = { -- Nga Mi
        [1] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 10 Nga Mi Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Nga My KiÕm ph¸p<enter>Nga My Ch­ëng ph¸p<color>",
            },
        ...
        [2] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 20 Nga Mi Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Tõ Hµng Phæ §é<color>",
            },
            ...
            [2] = {
                "GÆp DiÖu Nh­",
                "§Õn Gi¶ng Kinh ®­êng gÆp DiÖu Nh­, tiÕp nhËn nhiÖm vô thu phôc M·nh hæ",
                0, 1, 15, 1586, 3199,
            },
            [3] = {
                "§Õn M·nh Hæ huyÖt ®éng",
                "§Õn M·nh Hæ huyÖt ®éng phÝa sau nói, trong ®ã cã ba con B¹ch Hæ, ph¶i ®¸nh ba con nµy liªn tôc ba lÇn, sÏ khuÊt phôc ®­îc chóng.",
                1, 1, 14, 1784, 3197,
            },
            [4] = {
                "GÆp DiÖu Nh­",
                "Trë vÒ Gi¶ng Kinh ®­êng gÆp DiÖu Nh­ phôc mÖnh, hoµn thµnh nhiÖm vô",
                0, 1, 15, 1586, 3199,
            },
        },
        [3] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 30 Nga Mi Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Th«i Song Väng NguyÖt<enter>Tø T­îng §ång Quy<enter>Méng §iÖp<color>",
            },
        ...
        [4] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 40 Nga Mi Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>L­u Thñy<color>",
            },
            ...
            [12] = { "Trë vÒ gÆp T« Tõ Hinh, hoµn thµnh nhiÖm vô", "", 0, 1, 18, 1603,
                     3190 },
        },
        [5] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 50 Nga Mi Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>PhËt T©m Tõ H÷u<color>",
            },
            ...
            [4] = {
                "§¸nh b¹i Ph¶n T¨ng §Çu Môc cøu Tõ H¶i §¹i S­", "", 1, 1, 12, 1841,
                3181,
            },
        ...
        [7] = {
            [1] = {
                "<color=green>NhiÖm vô Trïng Ph¶n S­ M«n Nga Mi Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>BÊt DiÖt BÊt TuyÖt, PhËt Quang Phæ ChiÕu<enter>Phan ¢m Ph¹n X­íng<enter>PhËt Ph¸p V« Biªn<color>",
            },
        ...
        [8] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 90 Nga Mi Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Tam Nga TÕ NguyÖt<enter>Phong S­¬ng To¸i ¶nh<enter>Phæ §é Chóng Sinh<color>",
            },
    ...
    [5] = { -- Thuy yen
        [1] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 10 Thóy Yªn M«n<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Thóy Yªn §ao Ph¸p<enter>Thóy Yªn Song §ao<color>",
            },
            ...
            [4] = {
                "Trë vÒ giao Thóy Vò Tr©m cho Do·n Hµm Yªn, hoµn thµnh nhiÖm vô", "", 0,
                1, 161, 1591, 3203,
            },
        },
        [2] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 20 Thóy Yªn M«n<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>B¨ng T©m Tr¸i ¶nh<color>",
            },
            ...
            [13] = {
                "Trë vÒ giao cho Yªn HiÓu Tr¸i, hoµn thµnh nhiÖm vô", "", 0, 1, 160, 1593,
                3195,
            },
        },
        [3] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 30 Thóy Yªn M«n<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Vò §¶ Lª Hoa<enter>Phï V©n Tµn TuyÕt<color>",
            },
            ...
            [4] = {
                "Vµo Thæ PhØ S¬n §éng giÕt Thæ PhØ cøu con g¸i §oµn L·o Ho¸n", "", 1,
                1, 170, 1858, 3094,
            },
            [5] = { "Trë l¹i gÆp §oµn L·o Ho¸n", "", 0, 1, 162, 1512, 3277 },
            [6] = {
                "§Õn bÕn tµu mua Ng©n TuyÕt Ng­ cña ThuyÒn Gia", "", 1, 1, 162, 1640, 2935,
            },
            [7] = {
                "§Õn suèi Hå §iÖp thµnh §¹i Lý b¾t BÝch Th­êng Phông §iÖp", "", 0,
                1, 162, 1472, 3145,
            },
            [8] = { "§Õn V©n Léng §×nh b¾t Th»n L»n §á", "", 0, 1, 162, 1459, 3146 },
            [9] = {
                "Quay trë vÒ gÆp Hµ Mé TuyÕt, hoµn thµnh nhiÖm vô", "", 0, 1, 155, 1586,
                3205,
            },
        },
        [4] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 40 Thóy Yªn M«n<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Hé ThÓ Hµn B¨ng<color>",
            },
            ...
            [3] = {
                "§Õn ¸c B¸ gia ®Þa ®¹o tiªu diÖt ¸c B¸ §¶ Thñ", "", 1, 1, 163, 1789,
                3195,
            },
            [4] = { "Tiªu diÖt ¸c B¸ B¶o Tiªu", "", 1, 0, 171, 199, 191 },
            [5] = { "Tiªu diÖt ¸c B¸ Hé ViÖn", "", 1, 1, 172, 1550, 3040 },
            [6] = {
                "Tiªu diÖt ¸c B¸ §¶ Thñ t¹i tÇn 3 §iÓm Th­¬ng §éng", "", 1, 1, 173,
                1582, 2966,
            },
            [7] = { "Dïng 3 ch×a khãa më c¬ quan", "", 1, 1, 173, 1582, 2966 },
            [8] = {
                "Trë vÒ gÆp Yªn HiÓu Tr¸i, hoµn thµnh nhiÖm vô", "", 0, 1, 160, 1593,
                3195,
            },
        },
        [5] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 50 Thóy Yªn M«n<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>TuyÕt ¶nh<color>",
            },
            ...
            [4] = {
                "Tiªu diÖt Trém B¶o TÆc t¹i tÇng 1 Thiªn T©m Th¸p", "", 1, 1, 164, 1710,
                3088,
            },
            [5] = {
                "Tiªu diÖt Trém B¶o TÆc t¹i tÇng 2 Thiªn T©m Th¸p", "", 1, 1, 165, 1558,
                3232,
            },
            [6] = {
                "Tiªu diÖt Trém B¶o TÆc t¹i tÇng 3 Thiªn T©m Th¸p", "", 1, 1, 166, 1582,
                3200,
            },
            [7] = {
                "Mang Vò §ång Quan ¢m cho H­ Viªn Ph­¬ng Tr­îng", "", 0, 1, 162, 1750,
                3136,
            },
            [8] = {
                "Trë vÒ gÆp Do·n Hµm Yªn, hoµn thµnh nhiÖm vô", "", 0, 1, 161, 1591, 3203,
            },
        },
        [6] = {
            ...
            [3] = {
                "Tiªu diÖt th¶o khÊu t¹i cÊm ®Þa s¬n ®éng lÊy kh¨n t¬", "", 1, 1, 158,
                1504, 3098,
            },
            [4] = { "NhËn bøc th¬ tõ mét «ng giµ", "", 1, 1, 158, 1832, 3066 },
            [5] = { "Quay l¹i gÆp Xu©n Hoa Bµ Bµ", "", 0, 0, 154, 40, 74 },
            [6] = {
                "GÆp tr­ëng m«n Do·n Hµm Yªn, hoµn thµnh nhiÖm vô", "", 0, 1, 161, 1591,
                3203,
            },
        },
        [7] = {
            [1] = {
                "<color=green>NhiÖm vô Trïng Ph¶n S­ M«n Thóy Yªn<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Môc D· L­u Tinh<enter>BÝch H¶i TriÒu Sinh<enter>B¨ng Cèt TuyÕt T©m<color>",
            },
        ...
        [8] = { ----------------------------------------------------------------
            [1] = {
                "<color=green>NhiÖm vô cÊp 90 Thóy Yªn M«n<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>B¨ng Tung V« ¶nh<enter>B¨ng Tinh Tiªn Tö<color>",
            },
            ...
            [9] = {
                "Quay l¹i gÆp Ch­ëng m«n Do·n Hµm Yªn, hoµn thµnh nhiÖm vô", "", 0, 1,
            },
        },
        [9] = {
            [1] = {
    ...
    [6] = { -- Cai bang OK
        [1] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 10 C¸i Bang<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>C¸i Bang Bæng ph¸p<enter>C¸i Bang Ch­ëng ph¸p<color>",
            },
            ...
            [3] = {
                "§Õn Töu lÇu (mua 4 lo¹i r­îu, cÇn ng©n l­îng)", "", 0, 1, 80, 1731,
                3033,
            },
            [4] = {
                "GÆp Tóy b¸n tiªn (ngay bªn c¹nh - ®¸p ¸n B-C-D)", "", 0, 1, 80, 1731,
                3033,
            },
            [5] = {
                "Mang 5 lo¹i r­îu vÒ cho Hµ Nh©n Ng·, hoµn thµnh nhiÖm vô", "", 0, 1,
                115, 1527, 3706,
            },
        },
        [2] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 20 C¸i Bang<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Hãa HiÓm Vi Di<color>",
            },
            ...
            [4] = {
                "GÆp M¹nh Th­¬ng L­¬ng, hoµn thµnh nhiÖm vô", "", 0, 1, 115, 1555, 3792,
            },
        },
        [3] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 30 C¸i Bang<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Gi¸ng Long Ch­ëng<enter>§¶ CÈu TrËn<color>",
            },
        ...
        [4] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 40 C¸i Bang<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Ho¹t BÊt L­u Thñ<color>",
            },
            ...
            [3] = {
                "§¸nh b¹i Kim Quèc ThÝch Kh¸ch 1 (lÊy ThÝch s¸t mËt hµm - tû lÖ thÊp)",
                "", 1, 0, 180, 226, 183,
            },
            [4] = {
                "§¸nh b¹i Kim Quèc ThÝch Kh¸ch 2 (lÊy ThÝch s¸t mËt hµm - tû lÖ thÊp)",
                "", 1, 0, 180, 178, 195,
            },
            [5] = { "VÒ gÆp Ngôy LiÔu ¤ng", "", 0, 1, 115, 1529, 3866 },
            [6] = { "GÆp Tr­¬ng TuÊn", "", 0, 1, 80, 1608, 3154 },
            [7] = {
                "Trë l¹i gÆp Ngôy LiÔu ¤ng, hoµn thµnh nhiÖm vô", "", 0, 1, 115, 1529,
                3866,
            },
        },
        [5] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 50 C¸i Bang<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Bæng §¶ ¸c CÈu<enter>Hµng Long H÷u Hèi<color>",
            },
            ...
            [2] = { "§Õn gÆp Bang chñ Hµ Nh©n Ng·", "", 0, 1, 115, 1527, 3706 },
            [3] = {
                "GÆp vÖ binh hoµng cung L©m An (bÞ ng¨n l¹i kh«ng cho vµo)", "", 0, 1, 176,
                1634, 3203,
            },
            [4] = { "T×m Tr­¬ng Tu©n", "", 0, 1, 176, 1482, 3416 },
            [5] = { "Trë l¹i gÆp vÖ binh hoµng cung L©m An", "", 0, 1, 176, 1634, 3203 },
            [6] = {
                "Sau khi ®­a ®Þa ®å cho Tµo C«ng C«ng, trë vÒ gÆp Tr­¬ng TuÊn", "",
                0, 1, 176, 1482, 3416,
            },
            [7] = { "§ót lãt TiÓu Th¸i Gi¸m ®Ó vµo Hoµng Cung", "", 0, 1, 176, 1634, 3203 },
            [8] = {
                "§¸nh b¹i Tµo C«ng C«ng råi quay vÒ t×m Tr­¬ng Tu©n", "", 0, 1, 176,
                1482, 3416,
            },
            [9] = {
                "§Õn gÆp Bang chñ Hµ Nh©n Ng·, hoµn thµnh nhiÖm vô", "", 0, 1, 115, 1527,
                3706,
            },
        },
        [6] = {
            ...
            [3] = {
                "T1 ®¸nh b¹i Hæ QuyÒn (lÊy ch×a khãa - max 2 c¸i)", "", 1, 1, 116, 1711,
                3016,
            },
            [4] = { "T1 më r­¬ng Hæ QuyÒn. Max 2 tói", "", 1, 1, 116, 1775, 3087 },
            [5] = {
                "T2 kh«ng cÇn ch×a më r­¬ng 1. T2 2 r­¬ng max 1 tói", "", 1, 1, 117, 1615,
                3131,
            },
            [6] = {
                "T2 kh«ng cÇn ch×a më r­¬ng 2. T2 2 r­¬ng max 1 tói", "", 1, 1, 117, 1688,
                3022,
            },
            [7] = {
                "T4 kh«ng cÇn ch×a më r­¬ng 1. R­¬ng 1&2 max 2 tói", "", 1, 1, 119, 1518,
                3122,
            },
            [8] = {
                "T4 kh«ng cÇn ch×a më r­¬ng 2. R­¬ng 1&2 max 2 tói", "", 1, 1, 119, 1526,
                3192,
            },
            [9] = { "T4 ®¸nh b¹i VËt H¹c Hµnh (lÊy ch×a khãa)", "", 1, 1, 119, 1511, 3301 },
            [10] = {
                "T4 më r­¬ng (lÊy tói råi quay l¹i ®¸nh H¹c Hµnh lÊy ch×a khãa 2). Max 2 tói",
                "", 1, 1, 119, 1504, 3327,
            },
            ...
            [14] = {
                "§ñ 9 tói v¶i vÒ gÆp Tõ Tam Tr­îng, hoµn thµnh nhiÖm vô", "", 0, 1,
                115, 1512, 3790,
            },
        },
        [7] = {
            [1] = {
                "<color=green>NhiÖm vô Trïng Ph¶n S­ M«n C¸i Bang<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Tiªu Diªu C«ng<enter>Tóy §iÖp Cuång Vò<color>",
            },
        ...
        [8] = { ------------------------------------------------------------------------
            [1] = {
                "<color=green>NhiÖm vô cÊp 90 C¸i Bang<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Phi Long T¹i Thiªn<enter>Thiªn H¹ V« CÈu<color>",
            },
            ...
            [7] = {
                "Cøu ®­îc Giíi V« Tµ, quay vÒ gÆp La Khu«ng Sinh, hoµn thµnh nhiÖm vô",
                "",
            },
        },
        [9] = {
    ...
    [7] = { -- Thien nhan
        [1] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 10 Thiªn NhÉn<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Thiªn NhÉn §ao ph¸p<enter>Thiªn NhÉn M©u ph¸p<enter>Háa PhÇn Liªn Hoa<color>",
            },
        ...
        [2] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 20 Thiªn NhÉn<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>¶o ¶nh Phi Hå<color>",
            },
            -- [1] = {"SÏ ®­îc phong lµ: Tö SÜ. Häc ®­îc vâ c«ng: ¶o ¶nh Phi Hå. N¬i tiÕp nhËn nhiÖm vô: NhËt NguyÖt §µn Chñ ¤ Hîp T¸t."},
            [2] = {
                "GÆp ¤ Hîp T¸t (®¸p ¸n lµ H­íng xuèng ®Êt)", "", 1, 1, 45, 1604, 3181,
            },
        ...
        [3] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 30 Thiªn NhÉn<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Phi Hång V« TÝch<enter>LiÖt Háa T×nh Thiªn<enter>LiÖt Th«i S¬n §iÒn H¶i<color>",
            },
            ...
            [7] = {
                "Mang vÒ cho Hoµn Nhan TuyÕt Y, hoµn thµnh nhiÖm vô", "", 0, 1, 49, 1708,
                3226,
            },
        },
        [4] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 40 Thiªn NhÉn<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Bi T« Thanh Phong<color>",
            },
            ...
            [4] = {
                "Giao l¹i cho Gia LuËt TÞ Li, hoµn thµnh nhiÖm vô", "", 0, 1, 49, 1657, 3032,
            },
        },
        [5] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 50 Thiªn NhÉn<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>LÖ Ma §o¹t Hån<color>",
            },
            ...
            [4] = { "Më r­¬ng tÇng 1 (®Ó më c¬ quan lªn tÇng 2)", "", 1, 1, 38, 1665,
                    3246 },
            [5] = { "NhÊn vµo c¬ quan (®Ó lªn tÇng 2)", "", 1, 1, 38, 1705, 3131 },
            [6] = { "§¸nh §ao binh thèng lÜnh (lÊy ch×a khãa)", "", 1, 1, 39, 1734, 3128 },
            [7] = { "Më r­¬ng tÇng 2 (®Ó më c¬ quan lªn tÇng 3)", "", 1, 1, 39, 1639,
                    3201 },
            ...
            [11] = {
                "Trë vÒ gÆp §oan Méc DuÖ, hoµn thµnh nhiÖm vô", "", 0, 1, 49, 1800, 3184,
            },
        },
        [6] = {
            ...
            [5] = {
                "VÒ gÆp Khóc ThiÕt T­îng (lÊy YÓm NhËt KiÕm)", "", 0, 1, 37, 1746, 3052,
            },
            [6] = {
                "GÆp T«n Tó Tµi (®¸p ¸n b-c-a-b-a) lÊy §o¹n Thñy KiÕm", "", 0, 1, 37,
                1834, 2953,
            },
            [7] = {
                "GÆp con b¹c (mua ChuyÓn Ph¸ch KiÕm víi gi¸ 500 l­îng)", "", 0, 1, 37,
                1608, 3118,
            },
            [8] = { "GÆp §«ng Mai", "", 0, 1, 37, 1837, 3053 },
            [9] = { "GÆp TiÓu H¶i", "", 0, 1, 37, 1762, 3072 },
            [10] = { "Quay l¹i §«ng Mai b¸o tin (lÊy Khø Tµ KiÕm)", "", 0, 1, 37, 1837,
                     3053 },
            [11] = {
                "§Õn gÆp ¨n mµy (cho tiÒn 3 lÇn sÏ lÊy ®­îc DiÖt Hån KiÕm)", "", 0,
                1, 37, 1685, 2998,
            },
            [12] = {
                "Mang 5 thanh kiÕm vÒ cho Hoµn Nhan Hång LiÖt (sau ®ã tù ch¹y tíi cöa th¸nh ®éng ngay sau)",
                "", 0, 1, 49, 1721, 3129,
            },
            ...
            [13] = {
                "GÆp Hoµn Nhan Hång LiÖt, hoµn thµnh nhiÖm vô", "", 0, 1, 49, 1721, 3129,
            },
        },
        [7] = {
            [1] = {
                "<color=green>NhiÖm vô Trïng Ph¶n S­ M«n Thiªn NhÉn Gi¸o<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Th©u Thiªn Ho¸n NhËt<enter>Ma DiÖm ThÊt S¸t<enter>Thiªn Ma Gi¶i ThÕ<color>",
            },
        ...
        [8] = { --------------------------------------------------------
            [1] = {
                "<color=green>NhiÖm vô cÊp 90 Thiªn NhÉn Gi¸o<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>B¨ng Tung V« ¶nh<enter>B¨ng Tinh Tiªn Tö<color>",
            },
    ...
    [8] = { -- Vo dang
        [1] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 10 Vâ §ang Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Vâ §ang KiÕm Ph¸p<enter>Vâ §ang QuyÒn Ph¸p<color>",
            },
            ...
            [3] = {
                "GÆp DiÖp TiÕp Mü (ChØ cÇn nhÊp vµo nãi chuyÖn)", "", 0, 1, 81, 1703,
                3041,
            },
            [4] = {
                "Tr¶ lêi §¹o NhÊt Ch©n Nh©n (C,B,B), hoµn thµnh nhiÖm vô", "", 0, 1, 84,
                1598, 3183,
            },
        },
        [2] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 20 Vâ §ang Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>ThÊt Tinh TrËn<color>",
            },
            ...
            [3] = {
                "§¸nh Sãi §á 1 (LÊy Thiªn T»m Bµo r¸ch)",
                "§Õn khi nhËn ®­îc Thiªn T»m §¹o Bµo r¸ch", 1, 1, 83, 1510, 3050,
            },
            [4] = {
                "§¸nh Sãi §á 2 (LÊy Thiªn T»m Bµo r¸ch)",
                "§Õn khi nhËn ®­îc Thiªn T»m §¹o Bµo r¸ch", 1, 1, 83, 1642, 2899,
            },
            ...
            [7] = {
                "§¸nh D· H¸n 1 (Cøu ®øa bÐ, lÊy thiªn t»m)",
                "§Õn khi cøu ®­îc ®øa bÐ lÊy ®­îc Thiªn T»m", 1, 1, 83, 1582, 2860,
            },
            [8] = {
                "§¸nh D· H¸n 2 (Cøu ®øa bÐ, lÊy thiªn t»m)",
                "§Õn khi cøu ®­îc ®øa bÐ lÊy ®­îc Thiªn T»m", 1, 1, 83, 1676, 2932,
            },
            [9] = { "Trë l¹i T¹p Hãa ®Ó v¸ ¸o", "", 0, 1, 78, 1627, 3259 },
            [10] = {
                "Giao ¸o cho §µn Th¹ch M«n, hoµn thµnh nhiÖm vô", "", 0, 1, 86, 1605, 3187,
            },
        },
        [3] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 30 Vâ §ang Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>KiÕm Phi Kinh Thiªn<enter>B¸t CÊp Nhi Phôc<color>",
            },
            ...
            [10] = {
                "§ñ 5 cá häa mi vÒ giao cho Tõ §¹i Nh¹c, hoµn thµnh nhiÖm vô", "", 0,
                1, 85, 1598, 3187,
            },
        },
        [4] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 40 Vâ §ang Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>ThÕ V©n Tung<color>",
            },
            ...
            [12] = {
                "Giao th¬ cho §¹o NhÊt Ch©n Nh©n, hoµn thµnh nhiÖm vô", "", 0, 1, 84,
                1598, 3183,
            },
        },
        [5] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 50 Vâ §ang Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Täa Väng V« Ng·<color>",
            },
            ...
            [3] = {
                "§Çu môc thæ phØ ThiÕt T¸o (lÊy 1 v¹n l­îng)", "", 1, 1, 42, 1513, 3168,
            },
            [4] = { "GÆp §¬n T¬ Nam", "", 0, 1, 87, 1602, 3186 },
            [5] = { "T×m TrÞnh Gia TÈu Tö", "", 0, 1, 78, 1648, 3277 },
            [6] = { "Trë vÒ gÆp §¬n T¬ Nam, hoµn thµnh nhiÖm vô", "", 0, 1, 87, 1602,
                    3186 },
        },
        [6] = {
            ...
            [11] = {
                "VÒ më r­¬ng thø nhÊt (lÊy Ngäc Thanh ch©n kinh)", "", 1, 1, 81, 1897,
                2912,
            },
            ...
            [18] = {
                "VÒ më r­¬ng thø 2 (lÊy Th­îng Thanh ch©n kinh)", "", 1, 1, 81, 1897, 2876,
            },
            ...
            [22] = {
                "VÒ më r­¬ng thø 3 (lÊy Th¸i Thanh ch©n kinh)", "", 1, 1, 81, 1876, 2833,
            },
            [23] = {
                "VÒ gÆp §¹o NhÊt Ch©n Nh©n, hoµn thµnh nhiÖm vô", "", 0, 1, 84, 1598,
                3183,
            },
        },
        [7] = {
        ...
        [8] = { -------------------------------------------------
            [1] = {
                "<color=green>NhiÖm vô cÊp 90 Vâ §ang Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Thiªn §Þa V« Cùc<enter>Nh©n KiÕm Hîp NhÊt<color>",
            },
    ...
    [9] = { -- Con lon
        [1] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 10 C«n L«n Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>C«n L«n §ao Ph¸p<enter>C«n L«n KiÕm Ph¸p<enter>Thanh Phong Phï<enter>Thóc Ph­îc Chó<color>",
            },
        ...
        [2] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 20 C«n L«n Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Ky B¸n Phï<color>",
            },
            [2] = { "GÆp Th¸n Tøc L·o Nh©n nhËn nhiÖm vô", "", 0, 1, 131, 1526, 3225 },
            [3] = { "§¸nh Thæ PhØ lÊy X­¬ng ®Çu l¹c ®µ", "", 1, 1, 141, 1548, 3193 },
            [4] = {
                "Giao cho Th¸n Tøc L·o Nh©n, hoµn thµnh nhiÖm vô", "", 0, 1, 131, 1526,
                3225,
            },
        },
        [3] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 30 C«n L«n Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Thiªn TÕ TÊn L«i<enter>Thiªn Thanh §Þa Träc<enter>NhÊt KhÝ Tam Thanh<enter>B¾c Minh §¸o H¶i<color>",
            },
            [2] = { "GÆp Chu KhuyÕt §¹i S¬", "", 0, 1, 131, 1587, 3202 },
            [3] = { "§¸nh C¸o §á lÊy 3 D¹ Minh Ch©u", "", 1, 1, 145, 1629, 3222 },
            [4] = {
                "Giao cho Chu KhuyÕt §¹i S¬, hoµn thµnh nhiÖm vô", "", 0, 1, 131, 1587,
                3202,
            },
        },
        [4] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 40 C«n L«n Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Khi Hµn Ng¹o TuyÕt<enter>KhÝ T©m Phï<color>",
            },
            [2] = { "GÆp Thanh Liªn Tö nhËn nhiÖm vô", "", 0, 1, 139, 1606, 3199 },
            [3] = {
                "§¸nh b¹i Hång NguyÖt lÊy th«ng tin vÒ thanh kiÕm", "", 1, 1, 135, 1675,
                2853,
            },
            [4] = { "§¸nh Lam V©n lÊy ch×a khãa", "", 1, 1, 135, 1764, 3194 },
            [5] = { "Dïng ch×a khãa më r­¬ng", "", 1, 1, 135, 1529, 2804 },
            [6] = {
                "Giao HuyÕt Hån ThÇn KiÕm cho Thanh Liªn Tö, hoµn thµnh nhiÖm vô", "", 0,
                1, 139, 1606, 3199,
            },
        },
        [5] = {
            [1] = {
                "<color=green>NhiÖm vô cÊp 50 C«n L«n Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Mª Tung Hoan ¶nh<enter>Cuång Phong SËu §iÖn<color>",
            },
        ...
        [6] = {
            ...
            [5] = {
                "TiÕn vµo t©ng 2, chän Tôy Nh©n ®Ó lªn tÇng 2", "", 1, 1, 125, 1591, 3205,
            },
            [6] = { "§¸nh Thõa Phong, lÊy Viªm ®Õ táa", "", 1, 1, 126, 1614, 3015 },
            [7] = {
                "TiÕn vµo tÇng 3, chän Tinh VÖ ®Ó lªn tÇng 3", "", 1, 1, 126, 1674, 3060,
            },
            ...
            [11] = {
                "TiÕn ®Õn tÇng 5, chän §Êt trêi ph©n ®«i ®Ó lªn tÇng 5", "", 1, 1,
                128, 1521, 3057,
            },
            [12] = {
                "§¸nh b¹i N÷ ThÝch Kh¸ch, lÊy Hoµng ®Õ táa", "", 1, 1, 129, 1745, 3347,
            },
            [13] = {
                "TiÕn ®Õn tÇng 6, chän Hai bøc t­îng sóc vËt b»ng gç ®Ó lªn tÇng 6",
                "", 1, 1, 129, 1645, 3250,
            },
        ...
        [7] = {
            [1] = {
                "<color=green>NhiÖm vô Trïng Ph¶n S­ M«n C«n L«n Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Ngò L«i ChÝnh Ph¸p<enter>S­¬ng Ng¹o C«n L«n<color>",
            },
            [2] = { "§èi tho¹i Ch­ëng m«n, nép 5 v¹n l­îng", "", 0, 1, 138, 1596, 3196 },
        },
        [8] = { ----------------------------------------------
            [1] = {
                "<color=green>NhiÖm vô cÊp 90 C«n L«n Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Ng¹o TuyÕt Tiªu Phong<enter>L«i §éng Cöu Thiªn<color>",
            },
    ...
    [10] = { -- Hoa Son
        [1] = {
            [1] = {
                "NhiÖm vô cÊp 10 Hoa S¬n Ph¸i:<enter><color=green>LÊy n­íc th­ëng trµ<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>KiÕm T«ng Tæng QuyÕt<enter>Long NhiÔu Th©n<color>",
            },
        ...
        [2] = {
            [1] = {
                "NhiÖm vô cÊp 20 Hoa S¬n Ph¸i:<enter><color=green>Ngé KiÕm<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>D­ìng Ng« KiÕm Ph¸p<enter>H¶i N¹p B¸ch Xuyªn<color>",
            },
        ...
        [3] = {
            [1] = {
                "NhiÖm vô cÊp 30 Hoa S¬n Ph¸i:<enter><color=green>B¨ng Tµm Ngäc Lé Cao<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Kim Nh¹n Hoµnh Kh«ng<enter>Long HuyÒn KiÕm KhÝ<color>",
            },
            ...
            [5] = {
                "Quay l¹i «ng chñ hiÖu thuèc nép B¨ng Tµm ThuÕ", "", 0, 1, 1, 1598, 3195,
            },
            [6] = { "Quay l¹i hiÖu thuèc nhËn B¨ng Tµm Ngäc Lé Cao", "", 0, 1, 1, 1598,
                    3195 },
            [7] = { "Quay l¹i L¹n V©n Mi, hoµn thµnh nhiÖm vô", "", 0, 1, 987, 1306, 3019 },
        },
        [4] = {
            [1] = {
                "NhiÖm vô cÊp 40 Hoa S¬n Ph¸i:<enter><color=green>V©n Tö Tr¾c Thu B×nh<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Hi Di KiÕm Ph¸p<enter>KhÝ ChÊn S¬n Hµ<color>",
            },
        ...
        [5] = {
            [1] = {
                "NhiÖm vô cÊp 50 Hoa S¬n Ph¸i:<enter><color=green>VÜnh L¹c Phong V©n<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>Thiªn Th©n §¶o HuyÒn<enter>KhÝ Qu¸n Tr­êng Hång<color>",
            },
            ...
            [6] = {
                "§Õn Kim Quang §éng ®¸nh b¹i S¬n PhØ lÊy 3 Tµi VËt", "", 1, 1, 4, 1585,
                3109,
            },
            [7] = { "Giao tr¶ Tµi VËt cho d©n lµng", "", 0, 1, 99, 1622, 3202 },
            [8] = { "Quay l¹i L¹n H¹o Thiªn, hoµn thµnh nhiÖm vô", "", 0, 1, 987, 1359,
                    3050 },
        },
        [6] = {
            ...
            [4] = {
                "§¸nh b¹i §iÕu T×nh B¹ch Hæ lÊy B¹ch Hæ TuyÕt", "", 1, 1, 145, 1528,
                3319,
            },
        ...
        [7] = {
            [1] = {
                "<color=green>NhiÖm vô Trïng Ph¶n S­ M«n Hoa S¬n Ph¸i<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>HuyÒn Nh·n V©n Yªn<enter>Ma V©n KiÕm KhÝ<enter>Th­¬ng Tïng Nghªnh Kh¸ch<color>",
            },
            [2] = { "§èi tho¹i Ch­ëng M«n, nép 5 v¹n l­îng", "", 0, 1, 987, 1421, 3048 },
        },
        [8] = {
            [1] = {
                "NhiÖm vô cÊp 90 Hoa S¬n Ph¸i:<enter><color=green>T­¬ng D­¬ng KÕt Tri Kû<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>§o¹t MÖnh Liªn Hoµn Tam Tiªn KiÕm<enter>Ph¸ Th¹ch Ph¸ Ngäc<color>",
            },
            ...
            [8] = {
                "§i Phôc Ng­u S¬n §«ng h¹ 5 s¸t thñ Thiªn NhÉn Gi¸o", "", 1, 1, 90,
                1902, 3434,
            },
        ...
        [10] = {
            ...
            [3] = {
                "§i §iÓm Th­¬ng S¬n thu thËp H¾c Hoµng §µn", "", 1, 1, 167, 1511, 2473,
            },
...
function help_quest()
    ...
    if TenMP == "Vò Hån" then
        return Talk(1, "", "HiÖn t¹i ch­a ph¸t triÓn nhiÖm vô ph¸i Vò Hån.")
    end
    local tab_Content = {
        "NhiÖm vô cÊp 10 " .. TenMP .. "/#help_quest_step1(" .. nFaction .. ",1,2," ..
            getn(tb_HelpMonPhai[nFaction][1]) .. ")",
        "NhiÖm vô cÊp 20 " .. TenMP .. "/#help_quest_step1(" .. nFaction .. ",2,2," ..
            getn(tb_HelpMonPhai[nFaction][2]) .. ")",
        "NhiÖm vô cÊp 30 " .. TenMP .. "/#help_quest_step1(" .. nFaction .. ",3,2," ..
            getn(tb_HelpMonPhai[nFaction][3]) .. ")",
        "NhiÖm vô cÊp 40 " .. TenMP .. "/#help_quest_step1(" .. nFaction .. ",4,2," ..
            getn(tb_HelpMonPhai[nFaction][4]) .. ")",
        "NhiÖm vô cÊp 50 " .. TenMP .. "/#help_quest_step1(" .. nFaction .. ",5,2," ..
            getn(tb_HelpMonPhai[nFaction][5]) .. ")",
        "NhiÖm vô xuÊt s­ " .. TenMP .. "/#help_quest_step1(" .. nFaction .. ",6,2," ..
            getn(tb_HelpMonPhai[nFaction][6]) .. ")",
        "NhiÖm vô Trïng Ph¶n s­ m«n " .. TenMP .. "/#help_quest_step1(" .. nFaction .. ",7,2," ..
            getn(tb_HelpMonPhai[nFaction][7]) .. ")",
        "Ký danh ®Ö tö " .. TenMP .. "/#help_quest_step1(" .. nFaction .. ",10,2," ..
            getn(tb_HelpMonPhai[nFaction][10]) .. ")",
        "NhiÖm vô cÊp 90 " .. TenMP .. "/#help_quest_step1(" .. nFaction .. ",8,2," ..
            getn(tb_HelpMonPhai[nFaction][8]) .. ")",
        "Kü n¨ng 120 " .. TenMP .. "/#help_quest_step1(" .. nFaction .. ",9,2," ..
            getn(tb_HelpMonPhai[nFaction][9]) .. ")", "KÕt thóc ®èi tho¹i/Quit",
    }
    Say(
        "CÈm nang ®Æc biÖt gióp dÞch chuyÓn nhanh c¸c ®Þa ®iÓm lµm nhiÖm vô M«n Ph¸i.\nTruy cËp: <color=green>Youtube: PYTA GAMING<color> ®Ó update.",
...
function help_quest_step1( nFaction, nIDQ, nX, nY )
    ...
    if (nY1 - nX1 > 9) then nY1 = nX1 + 9; end
    if nIDQ == 1 then
    ...
    for i = nX1, nY1 do
        ...
        tinsert(tbOpt, {
            tb_HelpMonPhai[nFaction][nIDQ][i][1], help_quest_step2, {
                FightState, TypeMove, MapId, nX, nY, TenMP, TenNV,
                tb_HelpMonPhai[nFaction][nIDQ][i][2], tb_HelpMonPhai[nFaction][nIDQ][i][1],
            },
        })
    end
    if (nX1 ~= 2) then
...
function help_quest_step2(FightState, TypeMove, MapId, nX, nY, MonPhai, NhiemVu, BuocThucHien,
                          NoiDungNhiemVu )
    if TypeMove == 0 then
    ...
    SetFightState(FightState)
    Msg2Player(
        "§ang thùc hiÖn <color=yellow>" .. NhiemVu .. "<color> m«n ph¸i <color=yellow>" ..
            MonPhai .. "<color>. Néi dung nhiÖm vô: <color=green>" .. NoiDungNhiemVu .. "<color>")
    ...
    [2] = { -- Phô tuyÕn
        ...
        [3] = { --------------------------------------------Phô tuyÕn tµ ph¸i OK
            ...
            [4] = { -- Cap 50 OK
                [1] = { "GÆp Th¸c B¹t Hoµi Xuyªn", 0, 1, 37, 1677, 3040 },
                [2] = {
                    "Hoµn thµnh tèng kim vÒ gÆp Th¸c B¹t Hoµi Xuyªn", 0, 1, 37, 1677, 3040,
                },
...
function nvhoangkim()
    local Talk =
        "CÈm nang ®Æc biÖt nµy gióp dÞch chuyÓn nhanh c¸c ®Þa ®iÓm lµm nhiÖm vô Hoµng Kim.\nTruy cËp: <color=green>Youtube: PYTA GAMING<color> ®Ó update."
    local tb = { "ChÝnh tuyÕn/#gquest(1)", "Phô tuyÕn/#gquest(2)", "Tho¸t./Quit" }
    Say(Talk, getn(tb), tb)
    return 1
end
...
function gquest( ID )
    ...
    local tb = {
        ...
        "Tµ ph¸i - Long khÝ chi ho¹/#gquest_step1(" .. MissType .. ",3)", "Quay l¹i/main",
        "KÕt thóc ®èi tho¹i/Quit",
    }
    Say(Talk, getn(tb), tb)
end
function gquest_step1( ID1, ID2 )
    ...
    if MissType == 1 then -- chÝnh tuyÕn
        local tab_Content = {
            ...
            "Quay l¹i/main", "KÕt thóc ®èi tho¹i/Quit",
        }
        Say("Hç trî lµm nhiÖm vô hoµng kim <color=yellow>ChÝnh TuyÕn<color>",
            getn(tab_Content), tab_Content);
    elseif MissType == 2 then -- phô tuyÕn
        ...
        Say("Hç trî lµm nhiÖm vô hoµng kim <color=yellow>Phô TuyÕn<color>",
            getn(tab_Content), tab_Content);
    end
end
function gquest_step2( ID1, ID2, ID3 )
    local Talk =
        "<color=yellow>LÖnh bµi ®Æc biÖt nµy gióp dÞch chuyÓn nhanh c¸c ®Þa ®iÓm lµm nhiÖm vô Hoµng Kim<color>."
    local MissType = ID1 -- Lo¹i NV chÝnh hay phô
    local PheType = ID2 -- NhiÖm vô chÝnh - trung - tµ
    local CapDo = ID3
    ...
    for i = 1, TotalSelect do
        ...
        tinsert(tbOpt, {
            tb_HelpGoldQuest[MissType][PheType][CapDo][i][1], gquest_step3,
            { FightState, MapId, nX, nY },
        })
    end
    tinsert(tbOpt, { "Quay l¹i", main })
