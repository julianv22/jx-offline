...
tbDialog = JDialog
function main() -- chän lo¹i trang bÞ chÕ t¹o
...
function getItemLevel( nItemId, nEqIdx, nGenre, nDetail, nPart ) -- chän level trang bÞ
...
function getItemSeries( nItemLevel ) -- chän ngò hµnh trang bÞ
...
function getLine( nLine, nSeries, tbLineOpt ) -- chän c¸c dßng
...
function insertTable( tbOpt, nLine ) -- hiÓn thÞ c¸c dßng
