tbItemName = {
    ...
    [0] = {
        ...
        tbEquip = {{"HuyÒn ThiÕt KiÕm", 0, 0, 0}, {"§¹i Phong §ao", 0, 0, 1}, {"Kim C« Bæng", 0, 0, 2},
                   ...
                   {"TriÒn Thñ", 0, 0, 6}, {"Vò Hån §ao", 0, 0, 7}, {"Vò Hån ThuÉn", 0, 0, 8}}
    },
    -- VK xa
    [1] = {
...
function UpItemConfirm(nCount)
    for i = 1, nCount do
        ...
        if nLevel < 10 then
            ...
            Talk(1, "",
                "Th¨ng cÊp thµnh c«ng <color=yellow>" .. strItem .. "<color> thµnh <color=yellow>" .. strItem_new);
        else
...
function DownItemConfirm(nCount)
    for i = 1, nCount do
        ...
        if nLevel > 1 then
            ...
            Talk(1, "",
                "H¹ cÊp thµnh c«ng <color=yellow>" .. strItem .. "<color> thµnh <color=yellow>" .. strItem_new);
        else
