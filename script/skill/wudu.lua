...
SKILLS={
	...
	binglan_xuanjing={ --±ùÀ¼Ðþ¾§
		...
		function(level)
			return 
			"Thêi gian kh«i phôc chiªu thøc: <color=orange>"..floor(Link(level,SKILLS.binglan_xuanjing.skill_mintimepercast_v[1]) / 18).." gi©y<color>\n"
		end,
	},
	xuedao_dusha={ --Ñªµ¶¶¾É±
	...
	jiutian_kuanglei={ --¾ÅÌì¿ñÀ×
		...
		function(level)
			return 
			"Thêi gian kh«i phôc chiªu thøc: <color=orange>"..floor(Link(level,SKILLS.jiutian_kuanglei.skill_mintimepercast_v[1]) / 18).." gi©y<color>\n"
		end,
	},
	youming_kulou={ --ÓÄÚ¤÷¼÷Ã
	...
	chiyan_shitian={ --³àÑ×Ê´Ìì
		...
		function(level)
			return 
			"Thêi gian kh«i phôc chiªu thøc: <color=orange>"..floor(Link(level,SKILLS.chiyan_shitian.skill_mintimepercast_v[1]) / 18).." gi©y<color>\n"
		end,
	},
	chuanxin_duci={ --´©ÐÄ¶¾´Ì
		...
		function(level)
			return 
			"Thêi gian kh«i phôc chiªu thøc: <color=orange>"..floor(Link(level,SKILLS.chuanxin_duci.skill_mintimepercast_v[1]) / 18).." gi©y<color>\n"
		end,
	},
	wangu_shixin={ --Íò¹ÆÊ´ÐÄ
		...
		function(level)
			return 
			"Thêi gian kh«i phôc chiªu thøc: <color=orange>"..floor(Link(level,SKILLS.wangu_shixin.skill_mintimepercast_v[1]) / 18).." gi©y<color>\n"
		end,
	},
...
--		},
	...
	chuanyi_pojia={ --´©ÒÂÆÆ¼×
		...
		function(level)
			return 
			"Thêi gian kh«i phôc chiªu thøc: <color=orange>"..floor(Link(level,SKILLS.chuanyi_pojia.skill_mintimepercast_v[1]) / 18).." gi©y<color>\n"
		end,
	},
	wudu120={ --Îå¶¾120¼¼ÄÜ
